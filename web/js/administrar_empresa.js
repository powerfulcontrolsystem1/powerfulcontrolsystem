...
(function () {
  ...
  var links = [
    ...
    document.getElementById("linkRappi"),
  ...
  var menuPermissionCatalog = {
    ...
    linkRappi: { module: permModuleVentaPublica, action: permActionCreate },
    ...
    linkEquiposDomotica: { module: permModuleControlElectrico, action: permActionRead },
    linkTutorialDomotica: { module: permModuleControlElectrico, action: permActionRead },
