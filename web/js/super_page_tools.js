(function () {
  ...
  function installStyles() {
    ...
    style.textContent = [
      ...
      "@media(max-width:560px){.super-page-tools{position:static;right:auto;left:auto;bottom:auto;margin:12px 8px 8px auto;width:max-content;justify-content:flex-end}.super-page-tools button{font-size:.76rem;padding:7px 8px}}"
    ].join("\n");
