(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      ".erd-table-list{max-height:calc(100vh - 210px);overflow:auto;border-top:1px solid var(--border,#dbe3ef)}.erd-table-button{display:block;width:100%;min-width:0;overflow:hidden;border:0;border-bottom:1px solid var(--border,#edf1f6);background:transparent;color:inherit;text-align:left;padding:9px 4px;cursor:pointer}.erd-table-button:hover,.erd-table-button.is-selected{background:#eff6ff}.erd-table-button strong{display:block;font-family:Consolas,'Liberation Mono',monospace;font-size:.86rem;overflow-wrap:anywhere}.erd-table-button span{display:block;color:var(--muted,#64748b);font-size:.75rem;margin-top:2px;overflow-wrap:anywhere}",
