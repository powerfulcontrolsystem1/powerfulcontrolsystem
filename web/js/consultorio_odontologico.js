(function () {
  ...
  async function loadSection(label, loader) {
    try {
      ...
      return label + ": " + ((err && err.message) || "no disponible");
    }
  }
  ...
  async function refreshAll() {
    var errors = await Promise.all([
      loadSection("Dashboard", loadDashboard),
      loadSection("Pacientes", loadPacientes),
      loadSection("Profesionales", loadProfesionales),
      loadSection("Consultorios", loadConsultorios),
      loadSection("Citas", loadCitas),
      loadSection("Historias", loadHistorias),
      loadSection("Odontogramas", loadOdontogramas),
      loadSection("Tratamientos", loadTratamientos),
      loadSection("Presupuestos", loadPresupuestos),
      loadSection("Pagos", loadPagos)
    ]);
