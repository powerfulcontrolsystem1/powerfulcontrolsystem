(function () {
  ...
  function openChatDrawerFromUser() {
    if (!ensureEnterpriseChatEnabledForOpen()) return;
    if (isEnterpriseAIContext() && window.__pcsEnterpriseAIChromeAllowed === false) return;
    var drawer = document.getElementById(DRAWER_ID);
    var toggle = document.getElementById(TOGGLE_ID);
    var minibar = document.getElementById(MINIBAR_ID);
    if (!drawer || !toggle) return;
  ...
  function openChatDrawerForHelpPanel() {
    if (!ensureEnterpriseChatEnabledForOpen()) return false;
    if (isEnterpriseAIContext() && window.__pcsEnterpriseAIChromeAllowed === false) return false;
    var drawer = document.getElementById(DRAWER_ID);
    var toggle = document.getElementById(TOGGLE_ID);
    var minibar = document.getElementById(MINIBAR_ID);
