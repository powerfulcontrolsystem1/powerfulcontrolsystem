...
func DefaultAlquileresLicenciaPlans() []AlquileresLicenciaPlan {
	...
	return []AlquileresLicenciaPlan{
		...
		{
			Nombre:                 "Alquileres 30 dias - 1000 documentos",
			Descripcion:            "Plan alquileres para operacion mensual con hasta 1000 documentos electronicos o ventas.",
			Valor:                  60000,
			DuracionDias:           30,
		...
		{
			Nombre:                 "Alquileres 30 dias - 2000 documentos",
			Descripcion:            "Plan alquileres para operacion mensual con hasta 2000 documentos electronicos o ventas.",
			Valor:                  100000,
			DuracionDias:           30,
