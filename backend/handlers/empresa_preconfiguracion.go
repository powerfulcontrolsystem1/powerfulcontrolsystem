...
func applyEmpresaTipoPreconfiguracion(dbEmp, dbSuper *sql.DB, empresaID, tipoEmpresaID int64, tipoEmpresaNombre, usuario string) (*empresaPreconfigApplyResult, error) {
	...
	for idx, u := range template.Usuarios {
		...
		if err != nil {
			...
			log.Printf("[empresa_preconfiguracion] crear usuario empresa_id=%d email=%q error: %v", empresaID, redactEmailForLog(email), err)
			continue
		}
...
func defaultEmpresaPreconfigCarritoUI() map[string]any {
	return map[string]any{
		...
		"modo_busqueda_producto_carrito":           "codigo_barras",
		"permitir_cantidad_decimal_carrito":        false,
		"ajustar_alto_items_contenido_carrito":     true,
		"mostrar_todos_items_carrito":              false,
		...
		"totales_detalles_mostrar_entrada":         true,
		"totales_detalles_mostrar_salida":          true,
		"totales_detalles_mostrar_items":           true,
		"totales_detalles_mostrar_productos":       true,
		"totales_detalles_mostrar_servicios":       true,
		"totales_detalles_mostrar_total_productos": true,
		"totales_detalles_mostrar_total_servicios": true,
		"totales_detalles_mostrar_cliente":         true,
		"totales_detalles_mostrar_subtotal":        true,
		"totales_detalles_mostrar_descuento":       true,
		"totales_detalles_mostrar_impuesto":        true,
		"totales_detalles_mostrar_pagado":          true,
		"totales_detalles_mostrar_total":           true,
		"totales_detalles_mostrar_saldo":           true,
		...
		"facturacion_offline_habilitada":           true,
		...
		"atajos_pos_mostrar_ayuda":                 true,
		"atajos_pos": map[string]any{
			"ayuda":                 "F1",
			"buscar_producto":       "F2",
			"buscar_cliente":        "F3",
			"descuento":             "F4",
