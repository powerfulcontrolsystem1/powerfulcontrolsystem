...
Licencias y pagos
Las empresas pueden tener licencias activas, vencidas, de prueba o sin licencia. Una empresa sin licencia activa debe quedar restringida hasta renovacion o compra. Los codigos de descuento y licencias de prueba aplican una sola vez por empresa. El catalogo comercial visible debe exponer ocho licencias globales para todos los tipos de empresa: prueba gratis de 15 dias, prueba pagada de 1 dia por COP 5000, planes mensuales COP 60000, COP 110000 y COP 200000, y planes anuales COP 600000, COP 1100000 y COP 2200000. La compra adelantada de la misma licencia se limita por configuracion global, por defecto dos compras adicionales sobre la licencia activa. Si el valor final de una licencia es cero, el sistema debe activar la licencia sin pasar por Epayco y enviar correo de confirmacion. Si hay pago por Epayco, la activacion se produce solo tras confirmacion aprobada y debe quedar trazabilidad. La IA debe ayudar a diagnosticar pagos, webhooks, referencias, estado PENDING/APROBADO/RECHAZADO y correo, pero no debe inventar aprobaciones.

Tipos de empresa y preconfiguracion
Las siete preconfiguraciones basicas vigentes son Hotel, Motel, Restaurante, Bar, Pymes, Salon de belleza y Lavadero de autos. Taller de motos se conserva como sistema destacado para ordenes de trabajo, diagnostico, repuestos, mano de obra, garantias y entrega; no es una octava preconfiguracion. Cada empresa puede ajustar estaciones, nombres operativos, productos de prueba, usuarios guia, roles, tarifas, licencias, modulos habilitados y apariencia. La IA debe guiar al usuario a Tipos de empresas, Preconfiguracion de tipos, Licencias, Permisos y Configuracion del menu cuando corresponda.

Preconfiguraciones y motor comun
Las preconfiguraciones comparten el motor empresarial y no duplican los flujos de ventas, inventario, finanzas o seguridad. Cada operacion debe respetar empresa_id, licencia, modulos habilitados, permisos por rol y auditoria. Los tipos retirados no se publicitan ni se ofrecen al crear empresas nuevas; cualquier compatibilidad tecnica historica debe mantenerse interna y no presentarse como catalogo vigente.
