...
Licencias y pagos
Las empresas pueden tener licencias activas, vencidas, de prueba o sin licencia. Una empresa sin licencia activa debe quedar restringida hasta renovacion o compra. Los codigos de descuento y licencias de prueba aplican una sola vez por empresa. Si el valor final de una licencia es cero, el sistema debe activar la licencia sin pasar por Epayco y enviar correo de confirmacion. Si hay pago por Epayco, la activacion se produce solo tras confirmacion aprobada y debe quedar trazabilidad. La IA debe ayudar a diagnosticar pagos, webhooks, referencias, estado PENDING/APROBADO/RECHAZADO y correo, pero no debe inventar aprobaciones.

Tipos de empresa y preconfiguracion
El sistema soporta tipos como restaurante, motel, hotel, bar, salon de belleza, taller, lavadero de autos, tecnico independiente, punto de venta, consultorio/pacientes y otros. Cada tipo puede tener preconfiguracion: estaciones, nombres operativos, productos de prueba, usuarios guia, roles, tarifas y ajustes. Restaurante y bar usan mesas; motel y hotel usan habitaciones; salon de belleza usa sillas o puestos; lavadero usa bahias o puestos; taller puede usar motos, vehiculos o ordenes de servicio; tecnico independiente puede operar venta directa sin estaciones; punto de venta puede tener una estacion/caja principal. La IA debe adaptar su lenguaje al tipo de empresa.
