...
var superEmailTemplateDefinitions = []superEmailTemplateDefinition{
	...
	},
	{
		...
		Description: "Correo con token para restablecer contraseña del panel administrativo.",
		Recommended: true,
		...
		DefaultBodyHTML: "<html><body><p>Hola {{name}},</p><p>Recibimos una solicitud para restablecer tu contraseña.</p><p><strong>Token de recuperación:</strong><br/>{{token}}</p><p>Abre el login y usa el token para completar el restablecimiento: <a href=\"{{reset_url}}\">restablecer contraseña</a>.</p><p>Si no solicitaste este cambio, ignora este mensaje.</p></body></html>",
	},
	{
		...
		DefaultBodyHTML: "<html><body><p>Hola {{name}},</p><p>Recibimos una solicitud para restablecer tu contraseña.</p><p><strong>Token de recuperación (vigencia limitada):</strong><br/>{{token}}</p><p>Abre el login de usuario y usa el token para completar el restablecimiento: <a href=\"{{reset_url}}\">restablecer contraseña</a>.</p><p>Si no solicitaste este cambio, ignora este mensaje.</p></body></html>",
	},
	{
