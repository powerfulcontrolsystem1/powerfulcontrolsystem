...
var reporteModulosResumenDefs = []reporteModuloResumenDef{
	...
	{ModuloKey: "productos_import_export", Modulo: "Productos - Importar / exportar", Categoria: "operativo", Tabla: "productos", FechaCampo: "fecha_actualizacion"},
	{ModuloKey: "bodegas_traslados", Modulo: "Bodegas y traslados", Categoria: "operativo", Tabla: "inventario_movimientos", FechaCampo: "fecha_creacion"},
	...
	{ModuloKey: "turnos_atencion", Modulo: "Turnos de atencion", Categoria: "operativo", Tabla: "empresa_turnos_atencion_tickets", FechaCampo: "fecha_creacion"},
	{ModuloKey: "venta_publica", Modulo: "Venta publica - Ordenes", Categoria: "ventas", Tabla: "empresa_venta_publica_ordenes", FechaCampo: "fecha_creacion"},
	{ModuloKey: "red_social_comercial", Modulo: "Red social comercial", Categoria: "ventas", Tabla: "empresa_publicaciones_red_social", FechaCampo: "fecha_creacion"},
	{ModuloKey: "apartamentos_turisticos", Modulo: "Apartamentos turisticos", Categoria: "ventas", Tabla: "empresa_apartamentos_turisticos_reservas", FechaCampo: "fecha_creacion"},
	{ModuloKey: "parqueadero", Modulo: "Parqueadero", Categoria: "ventas", Tabla: "empresa_parqueadero_tickets", FechaCampo: "fecha_creacion"},
	{ModuloKey: "domicilios", Modulo: "Domicilios", Categoria: "ventas", Tabla: "empresa_domicilios_orders", FechaCampo: "fecha_creacion"},
	{ModuloKey: "taxi_system", Modulo: "Taxi system", Categoria: "ventas", Tabla: "empresa_taxi_requests", FechaCampo: "fecha_creacion"},
	{ModuloKey: "tarifas_motel", Modulo: "Tarifas motel", Categoria: "configuracion", Tabla: "empresa_tarifas_motel", FechaCampo: "fecha_creacion"},
	{ModuloKey: "compras_avanzadas", Modulo: "Compras avanzadas", Categoria: "compras", Tabla: "empresa_compras_requisiciones", FechaCampo: "fecha_creacion"},
	{ModuloKey: "ordenes_compra", Modulo: "Ordenes de compra", Categoria: "compras", Tabla: "empresa_ordenes_compra", FechaCampo: "fecha_creacion"},
	{ModuloKey: "proveedores", Modulo: "Proveedores", Categoria: "compras", Tabla: "empresa_proveedores", FechaCampo: "fecha_creacion"},
	{ModuloKey: "soportes_compras_ia", Modulo: "Captura IA de compras y gastos", Categoria: "compras", Tabla: "empresa_soportes_compras_ia", FechaCampo: "fecha_creacion"},
	{ModuloKey: "importaciones_costeo", Modulo: "Importaciones y costeo", Categoria: "compras", Tabla: "empresa_importaciones_costeo", FechaCampo: "fecha_creacion"},
	{ModuloKey: "facturacion_reintentos", Modulo: "Facturacion electronica - Reintentos", Categoria: "facturacion", Tabla: "facturacion_electronica_reintentos", FechaCampo: "fecha_actualizacion"},
	{ModuloKey: "facturacion_pais", Modulo: "Facturacion electronica por pais", Categoria: "facturacion", Tabla: "facturacion_electronica_pais", FechaCampo: "fecha_actualizacion"},
	{ModuloKey: "creditos", Modulo: "Creditos y cartera", Categoria: "finanzas", Tabla: "empresa_creditos", FechaCampo: "fecha_creacion"},
	{ModuloKey: "creditos_workflow", Modulo: "Creditos - Workflow", Categoria: "finanzas", Tabla: "empresa_creditos_workflow", FechaCampo: "fecha_creacion"},
	{ModuloKey: "cobranza", Modulo: "Cobranza - Gestiones", Categoria: "finanzas", Tabla: "empresa_cobranza_gestiones", FechaCampo: "fecha_creacion"},
	{ModuloKey: "tesoreria", Modulo: "Tesoreria y presupuesto", Categoria: "finanzas", Tabla: "empresa_tesoreria_presupuestos", FechaCampo: "fecha_creacion"},
	{ModuloKey: "tesoreria_flujo_caja", Modulo: "Tesoreria - Flujo de caja", Categoria: "finanzas", Tabla: "empresa_tesoreria_flujo_caja", FechaCampo: "fecha_flujo"},
	{ModuloKey: "bancos_movimientos", Modulo: "Bancos y pagos", Categoria: "finanzas", Tabla: "empresa_finanzas_bancos_movimientos", FechaCampo: "fecha_movimiento"},
	{ModuloKey: "breb_qr", Modulo: "Pagos Bre-B QR", Categoria: "finanzas", Tabla: "empresa_finanzas_bancos_movimientos", FechaCampo: "fecha_movimiento"},
	{ModuloKey: "centros_costo", Modulo: "Centros de costo", Categoria: "finanzas", Tabla: "empresa_centros_costo", FechaCampo: "fecha_creacion"},
	{ModuloKey: "suite_contador", Modulo: "Suite contador", Categoria: "contable", Tabla: "", FechaCampo: ""},
	{ModuloKey: "niif", Modulo: "Modulo NIIF", Categoria: "contable", Tabla: "", FechaCampo: ""},
	{ModuloKey: "renta_ia", Modulo: "Renta IA", Categoria: "finanzas", Tabla: "", FechaCampo: ""},
	{ModuloKey: "bolsa", Modulo: "Bolsa empresarial", Categoria: "finanzas", Tabla: "", FechaCampo: ""},
	{ModuloKey: "contabilidad_colombia", Modulo: "Contabilidad Colombia", Categoria: "contable", Tabla: "empresa_contabilidad_colombia_comprobantes", FechaCampo: "fecha_comprobante"},
	{ModuloKey: "contabilidad_colombia_lineas", Modulo: "Contabilidad Colombia - Lineas", Categoria: "contable", Tabla: "empresa_contabilidad_colombia_lineas", FechaCampo: "fecha_creacion"},
	{ModuloKey: "contabilidad_exogena", Modulo: "Informacion exogena DIAN", Categoria: "contable", Tabla: "empresa_contabilidad_exogena_registros", FechaCampo: "fecha_creacion"},
	{ModuloKey: "contabilidad_nomina_electronica", Modulo: "Contabilidad - Nomina electronica", Categoria: "contable", Tabla: "empresa_contabilidad_nomina_electronica", FechaCampo: "fecha_actualizacion"},
	{ModuloKey: "contabilidad_documento_soporte", Modulo: "Contabilidad - Documento soporte", Categoria: "contable", Tabla: "empresa_contabilidad_documentos_soporte", FechaCampo: "fecha_creacion"},
	{ModuloKey: "activos_fijos_niif", Modulo: "Activos fijos NIIF/Fiscal", Categoria: "contable", Tabla: "empresa_contabilidad_activos_fijos", FechaCampo: "fecha_creacion"},
	{ModuloKey: "activos_depreciacion", Modulo: "Activos - Depreciacion", Categoria: "contable", Tabla: "empresa_contabilidad_activos_depreciacion", FechaCampo: "fecha_depreciacion"},
	{ModuloKey: "cierre_fiscal", Modulo: "Cierre fiscal", Categoria: "contable", Tabla: "empresa_cierre_fiscal_periodos", FechaCampo: "fecha_actualizacion"},
	{ModuloKey: "declaraciones_tributarias", Modulo: "Declaraciones tributarias", Categoria: "contable", Tabla: "empresa_declaraciones_tributarias", FechaCampo: "fecha_creacion"},
	{ModuloKey: "portal_contador", Modulo: "Portal contador", Categoria: "contable", Tabla: "empresa_portal_contador_clientes", FechaCampo: "fecha_creacion"},
	{ModuloKey: "portal_contador_obligaciones", Modulo: "Portal contador - Obligaciones", Categoria: "contable", Tabla: "empresa_portal_contador_obligaciones", FechaCampo: "fecha_creacion"},
	{ModuloKey: "portal_terceros_certificados", Modulo: "Portal terceros y certificados", Categoria: "contable", Tabla: "empresa_portal_terceros", FechaCampo: "fecha_creacion"},
	{ModuloKey: "certificados_tributarios", Modulo: "Certificados tributarios", Categoria: "contable", Tabla: "empresa_certificados_tributarios", FechaCampo: "fecha_creacion"},
	{ModuloKey: "nomina_empleados", Modulo: "Nomina - Empleados", Categoria: "rrhh", Tabla: "empresa_nomina_empleados", FechaCampo: "fecha_creacion"},
	{ModuloKey: "nomina_colombia_novedades", Modulo: "Nomina Colombia - Novedades", Categoria: "rrhh", Tabla: "empresa_nomina_colombia_novedades", FechaCampo: "fecha_creacion"},
	{ModuloKey: "horarios_trabajadores", Modulo: "Horarios laborales", Categoria: "rrhh", Tabla: "empresa_horarios_trabajadores", FechaCampo: "fecha_creacion"},
	{ModuloKey: "asistencia_empleados", Modulo: "Asistencia empleados", Categoria: "rrhh", Tabla: "empresa_asistencia_empleados", FechaCampo: "fecha_creacion"},
	{ModuloKey: "auditoria_ia", Modulo: "Auditoria IA", Categoria: "seguridad", Tabla: "empresa_auditoria_ia_consultas", FechaCampo: "fecha_creacion"},
	{ModuloKey: "produccion_mrp", Modulo: "Produccion / MRP", Categoria: "produccion", Tabla: "empresa_produccion_ordenes", FechaCampo: "fecha_creacion"},
	{ModuloKey: "logistica_wms", Modulo: "Logistica WMS", Categoria: "logistica", Tabla: "empresa_wms_ordenes", FechaCampo: "fecha_creacion"},
	{ModuloKey: "onlyoffice", Modulo: "Documentos OnlyOffice", Categoria: "documental", Tabla: "empresa_documentos_gestion", FechaCampo: "fecha_creacion"},
	{ModuloKey: "gestion_documental", Modulo: "Gestion documental", Categoria: "documental", Tabla: "empresa_documentos_gestion", FechaCampo: "fecha_creacion"},
	{ModuloKey: "email_corporativo", Modulo: "Email corporativo", Categoria: "documental", Tabla: "empresa_email_corporativo", FechaCampo: "fecha_creacion"},
	{ModuloKey: "buzon", Modulo: "Buzon interno", Categoria: "comunicaciones", Tabla: "empresa_buzon_mensajes", FechaCampo: "fecha_creacion"},
	{ModuloKey: "tareas_buzon", Modulo: "Tareas internas", Categoria: "comunicaciones", Tabla: "empresa_buzon_mensajes", FechaCampo: "fecha_creacion"},
	{ModuloKey: "chat_empresarial", Modulo: "Chat empresarial", Categoria: "comunicaciones", Tabla: "empresa_chat_mensajes", FechaCampo: "fecha_creacion"},
	{ModuloKey: "buzon_adjuntos", Modulo: "Buzon - Adjuntos", Categoria: "comunicaciones", Tabla: "empresa_buzon_adjuntos", FechaCampo: "fecha_creacion"},
	{ModuloKey: "impresoras", Modulo: "Impresoras y agente local", Categoria: "operativo", Tabla: "empresa_impresoras", FechaCampo: "fecha_creacion"},
	{ModuloKey: "impresoras_cola", Modulo: "Impresoras - Cola", Categoria: "operativo", Tabla: "empresa_impresoras_cola", FechaCampo: "fecha_creacion"},
	{ModuloKey: "menu_visible", Modulo: "Menu visible por empresa", Categoria: "configuracion", Tabla: "empresa_estacion_prefs", FechaCampo: "fecha_actualizacion"},
	{ModuloKey: "atajos_pos", Modulo: "Atajos POS", Categoria: "configuracion", Tabla: "empresa_estacion_prefs", FechaCampo: "fecha_actualizacion"},
	{ModuloKey: "soporte_remoto", Modulo: "Soporte remoto", Categoria: "soporte", Tabla: "empresa_soporte_remoto_sesiones", FechaCampo: "fecha_creacion"},
	{ModuloKey: "backups", Modulo: "Backups empresariales", Categoria: "seguridad", Tabla: "empresa_backups", FechaCampo: "fecha_creacion"},
	{ModuloKey: "control_electrico", Modulo: "Domotica / Control electrico", Categoria: "analisis_control", Tabla: "empresa_control_electrico_eventos", FechaCampo: "fecha_evento"},
	{ModuloKey: "energia_solar", Modulo: "Energia solar", Categoria: "analisis_control", Tabla: "empresa_energia_solar_sistemas", FechaCampo: "fecha_creacion"},
	{ModuloKey: "camaras", Modulo: "Camaras y DVR", Categoria: "analisis_control", Tabla: "empresa_camaras", FechaCampo: "fecha_creacion"},
	{ModuloKey: "grafologia", Modulo: "GRAFOLOGIX", Categoria: "analisis_control", Tabla: "empresa_grafologia_analisis", FechaCampo: "fecha_creacion"},
	{ModuloKey: "ubicacion_gps", Modulo: "Ubicacion GPS", Categoria: "analisis_control", Tabla: "empresa_gps_dispositivos", FechaCampo: "fecha_creacion"},
	{ModuloKey: "hoja_vida_operativa", Modulo: "Hoja de vida operativa", Categoria: "analisis_control", Tabla: "empresa_hoja_vida_eventos", FechaCampo: "fecha_evento"},
	{ModuloKey: "carnets", Modulo: "Carnets empresariales", Categoria: "personas_activos", Tabla: "empresa_carnets", FechaCampo: "fecha_creacion"},
	{ModuloKey: "vehiculos_registro", Modulo: "Registro de vehiculos", Categoria: "personas_activos", Tabla: "empresa_vehiculos_registro", FechaCampo: "fecha_creacion"},
	{ModuloKey: "gimnasio", Modulo: "Gimnasio", Categoria: "verticales", Tabla: "empresa_gimnasio_socios", FechaCampo: "fecha_creacion"},
	{ModuloKey: "odontologia", Modulo: "Consultorio odontologico", Categoria: "verticales", Tabla: "empresa_odontologia_citas", FechaCampo: "fecha_creacion"},
	{ModuloKey: "alquileres", Modulo: "Alquileres", Categoria: "verticales", Tabla: "empresa_alquileres_contratos", FechaCampo: "fecha_creacion"},
	{ModuloKey: "propiedad_horizontal", Modulo: "Propiedad horizontal", Categoria: "verticales", Tabla: "empresa_propiedad_horizontal_recaudos", FechaCampo: "fecha_creacion"},
	{ModuloKey: "aiu_construccion", Modulo: "Construccion / AIU", Categoria: "verticales", Tabla: "empresa_aiu_contratos", FechaCampo: "fecha_creacion"},
	{ModuloKey: "modulos_colombia", Modulo: "Modulos Colombia configurables", Categoria: "verticales", Tabla: "empresa_modulos_colombia_registros", FechaCampo: "fecha_creacion"},
	{ModuloKey: "centro_ia_empresarial", Modulo: "Centro IA empresarial", Categoria: "ia", Tabla: "empresa_ai_consultas", FechaCampo: "fecha_creacion"},
	{ModuloKey: "uso_ia_empresarial", Modulo: "Uso diario IA empresarial", Categoria: "ia", Tabla: "empresa_ai_uso_diario", FechaCampo: "fecha_dia"},
}
...
func (b *reportesBuilder) buildOperativoModulosResumenDataset() (empresaReporteDataset, error) {
	...
	for _, mod := range reporteModulosResumenDefs {
		...
		if strings.TrimSpace(mod.Tabla) == "" {
			modulosSinTabla++
			row["tabla"] = "sin_tabla"
			row["nota"] = "modulo_hub_o_calculado_sin_tabla_propia"
