- 2026-07-30: `Precisión monetaria visible en Finanzas` conserva el formato compacto para importes enteros y muestra dos decimales cuando existe unidad menor, evitando que un pago CxP real de `0,01` aparezca como `$ 0`. No modifica cálculos ni persistencia; requiere repetición visual en el candidato inmutable.
