- 2026-08-25: `RUT DIAN por empresa` agrega en Facturacion electronica un cargador separado del Formulario 1876. El PDF real de hasta 12 MB se procesa temporalmente con GPT-5.5, el backend normaliza NIT/DV, ubicacion DANE y responsabilidades, y la UI exige revisar, aplicar y guardar los datos sin almacenar el archivo ni activar/emitir documentos fiscales.
