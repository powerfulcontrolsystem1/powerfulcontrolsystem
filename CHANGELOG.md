- 2026-08-24: `Factura DIAN desde fuente fiscal real` captura un snapshot privado e inmutable por venta, genera UBL multilínea sin partes, direcciones, productos ni identificadores ficticios, agrega códigos DANE validados a emisor y clientes, pre valida la fuente antes del pago y rechaza ajustes globales no distribuidos. También cifra secretos DIAN por tenant/campo, cierra rutas libres de firma/envío y publica nota crédito/débito como bloqueadas hasta tener fuente de ajuste. La suite Go/vet, JavaScript, PostgreSQL 17.11, XSD UBL 2.1 oficial, XMLDSig independiente y Schematron DIAN aprueban; clon del esquema vigente, portal/acuse DIAN, despliegue y emisión real siguen pendientes.
