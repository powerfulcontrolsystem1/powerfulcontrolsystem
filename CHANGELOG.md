- 2026-07-09: `Retiro integral de juegos/emuladores y contexto documental` elimina frontend, runtime, assets, rutas, Docker, records y tabla exclusiva `super_juegos_records`; agrega contexto general obligatorio e indice especifico para agentes.
