- 2026-08-13: `Plan 110: preconfiguración sin DDL HTTP` reemplaza diez inicializaciones de esquema en solicitudes por verificadores fail-closed ya migrados para productos, usuarios, operación, comisiones, tarifas y Domótica; la limpieza propaga errores y el inventario runtime baja a 94 llamadas, 19 HTTP. También corrige permisos y ruta del auditor señalados por gosec. No se ejecutó `rs`.
