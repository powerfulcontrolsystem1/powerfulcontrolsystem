- 2026-08-13: `Plan 110: rutas empresariales sin DDL HTTP` reemplaza inicializaciones de esquema por verificadores fail-closed para preconfiguración, eventos contables, permisos finos, Nextcloud, correo masivo, Rappi y permisos por rol; el inventario runtime baja a 87 llamadas, 12 HTTP. También corrige permisos y ruta del auditor señalados por gosec. No se ejecutó `rs`.
