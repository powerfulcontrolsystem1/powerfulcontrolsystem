- 2026-06-19: `Pagos de licencias listos para produccion` revisa el flujo de licencias con Epayco y Wompi: ambos metodos se exponen desde `/api/public/licencias/payment_methods` cuando el pais/credenciales estan activos y cada checkout vuelve a validar disponibilidad antes de crear transaccion. Las tarjetas de licencias muestran precio anterior tachado para COP 60.000 (antes 70.000), COP 110.000 (antes 120.000) y COP 200.000 (antes 220.000). QA: pruebas enfocadas Go de pagos/licencias y chequeo sintactico JS de elegir/pagar licencia.
