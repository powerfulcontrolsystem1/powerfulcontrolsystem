- 2026-06-05: `SOAP WS-Security DIAN` agrega seguridad WS-Security al sobre oficial `SendTestSetAsync` para endpoints `dian.gov.co`, usando Timestamp, BinarySecurityToken, firma RSA-SHA256 y referencias firmadas a encabezados/body/token; se valida el TestSetId real de Powerful Control System sin exponer secretos.
