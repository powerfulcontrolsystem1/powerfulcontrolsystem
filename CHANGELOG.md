- 2026-08-12: `Plan 110: timeout IA, botones, Mailu y CSP de observacion` limita la extraccion de soportes a 90 segundos con cancelacion y devolucion de cuota, corrige el mensaje del boton IA de Productos hacia el shell superior, agrega inventario reproducible de 20 controles IA, concilia el buzon solo tras autenticar INBOX por el front Mailu y activa por defecto la CSP Report-Only estricta del backend. Las correcciones son locales y no se ejecuto `rs`.
