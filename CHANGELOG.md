- 2026-07-28: `Configuración operativa del carrito` alinea el SELECT PostgreSQL de reglas por rol con sus 18 destinos de Scan, incluyendo permisos de ingresos y egresos manuales. Corrige el HTTP 500 reproducido en staging para PCS sin cambiar el filtro `empresa_id`.
