- 2026-06-17: `DIAN produccion PCS e idempotencia Regla 90` confirma en produccion la factura `1PCS2` de PCS (`empresa_id=12`) como emitida/aceptada con CUFE y codigo de validacion, usando prefijo `1PCS`, resolucion `18764111318575`, rango `1-100000` y Software ID asociado en DIAN. El backend trata `Regla: 90, Documento procesado anteriormente` como respuesta idempotente aceptada para reenvios de documentos ya procesados por DIAN.
