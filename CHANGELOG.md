- 2026-06-13: `Snapshot de permisos preserva super administrador PCS` fuerza el rol `super_administrador` para `powerfulcontrolsystem@gmail.com` tambien en el snapshot cacheado de autorizacion de `administrar_empresa`, y purga de forma defensiva el usuario operativo duplicado antes de considerar roles empresariales.
