- 2026-08-21: `Familias DIAN sin falsa compatibilidad` limita la emision real al adaptador implementado de factura/nota credito/nota debito, bloquea con 422 soporte, nomina, equivalentes y RADIAN antes de cualquier efecto fiscal, publica disponibilidad por tipo y evita contar el comprobante `CP-*` asociado como una segunda factura electronica. Auditoria visual autenticada realizada; sin despliegue ni nuevos envios reales.
