- 2026-08-13: `Plan 110: rutas empresariales sin DDL HTTP` reemplaza inicializaciones de esquema por verificadores fail-closed para preconfiguración, eventos contables, permisos finos, Nextcloud y correo masivo; la limpieza propaga errores y el inventario runtime baja a 89 llamadas, 14 HTTP. También corrige permisos y ruta del auditor señalados por gosec. No se ejecutó `rs`.
