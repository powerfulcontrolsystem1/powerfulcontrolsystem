- 2026-08-13: `Plan 110: rutas empresariales sin DDL HTTP` reemplaza inicializaciones de esquema por verificadores fail-closed para preconfiguración, contabilidad, permisos, Nextcloud, correo masivo, Rappi, alertas y agentes de mantenimiento; el inventario runtime baja a 85 llamadas, 10 HTTP. También corrige permisos y ruta del auditor señalados por gosec. No se ejecutó `rs`.
