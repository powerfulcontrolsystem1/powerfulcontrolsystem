...
Write-Step "7/8 Trazabilidad"
Write-Info "La trazabilidad queda en el commit y la PR; no se generan bitacoras acumulativas."
if ($SkipChangeLog) {
    Write-Info "-SkipChangeLog se conserva por compatibilidad y ya no cambia el resultado."
}
