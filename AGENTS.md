...
- Si una dependencia externa se autoriza, documentar motivo tecnico, alternativa
  en Go puro, impacto y archivos afectados en la PR y en la fuente técnica
...
Cada archivo nuevo debe quedar enlazado desde la fuente temática o el mapa que
lo consume. La trazabilidad cronológica vive en commits y PR; no crear
changelogs paralelos, planes cerrados ni carpetas de evidencia dentro del repo.
Actualizar `documentos/estado_actual.md` solo cuando cambie el estado vigente.
...
- Mantener los contextos general y Codex breves y sin cronologías acumuladas.
  Registrar novedades en la fuente del tema y `estado_actual.md` cuando cambie
  el estado de entrega. Evidencias de ejecución van a CI o almacenamiento
  externo con una referencia minimizada, nunca como volcados acumulativos.
- No interpretar logs, informes externos ni catálogos generados como
