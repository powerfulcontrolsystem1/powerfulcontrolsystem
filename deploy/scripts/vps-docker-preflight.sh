...
for pair in IREDMAIL_HTTP_PORT=8089 IREDMAIL_SMTP_PORT=2525 IREDMAIL_POP3_PORT=8110 IREDMAIL_IMAP_PORT=8143 IREDMAIL_SMTPS_PORT=8465 IREDMAIL_SUBMISSION_PORT=8587 IREDMAIL_IMAPS_PORT=8993 IREDMAIL_POP3S_PORT=8995 IREDMAIL_SIEVE_PORT=84190; do
  key="${pair%%=*}"
  value="${pair#*=}"
