...
4. Actualizar las fuentes afectadas: contrato, datos, permisos, arquitectura, ayuda y runbook. Registrar archivos nuevos, historial y changelog.
...
Revisar el catálogo generado antes de entregar; regenerar no certifica el contenido. Los documentos heredados con hallazgos siguen identificados. Una nueva fuente principal se añade a la política del catálogo con responsable y fecha de revisión real.
