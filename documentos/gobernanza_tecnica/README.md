...
Los planes cerrados no se conservan en el repositorio operativo. La evolución se
consulta en commits y PR; no inferir disponibilidad actual de logs, respaldos o
evidencia externa.
