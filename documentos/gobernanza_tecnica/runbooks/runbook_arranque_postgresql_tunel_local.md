...
- `backend/.env.local`
- variables de entorno del proceso: `DB_DIALECT`, `DB_EMPRESAS_DSN`, `DB_SUPERADMIN_DSN`, `DB_VPS_TUNNEL_ENABLED`, `DB_VPS_LOCAL_PORT`, `DB_VPS_SSH_HOST`, `DB_VPS_SSH_USER`, `DB_VPS_SSH_PORT`, `DB_VPS_REMOTE_HOST`, `DB_VPS_REMOTE_PORT`
