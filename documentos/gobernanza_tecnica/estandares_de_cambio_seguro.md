...
4. La fuente o mapa que consume un archivo nuevo, movido o retirado.
5. `documentos/estado_actual.md` únicamente si cambia el estado vigente.
6. La PR con pruebas, límites y referencia a evidencia externa minimizada.
