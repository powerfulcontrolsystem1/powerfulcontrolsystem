...
Consolidar las recetas breves de deploy/rollback en el runbook de release existente. Conservar evidencia de ejecución en CI o almacenamiento externo, enlazada desde la PR cuando sea necesaria. No agregar dependencias ni cambiar runtime de aplicación.
...
Los archivos retirados se recuperan desde el respaldo externo de la reescritura, no desde la rama operativa. Una reversión documental debe mantener cambios previos del usuario y no reactivar planes cerrados como órdenes. El [marco](../marco_documental.md) y las [brechas](../riesgos_y_brechas.md) gobiernan el snapshot actual.
