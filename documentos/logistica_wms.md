...
[logistica_wms.go](../backend/handlers/logistica_wms.go), [logistica_wms.go](../backend/db/logistica_wms.go), [logistica_wms_test.go](../backend/db/logistica_wms_test.go), [logistica_wms.html](../web/administrar_empresa/logistica_wms.html), [main.go](../backend/main.go), [empresa_permisos.go](../backend/handlers/empresa_permisos.go).
