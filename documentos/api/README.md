...
Actualizar contrato y generador/overrides aplicables en la misma entrega; comparar inventario con `backend/main.go` y tratar cualquier diferencia como un defecto del snapshot actual.
