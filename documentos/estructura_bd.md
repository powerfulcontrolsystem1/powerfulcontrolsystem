...
Actualizacion 2026-07-12 (Nextcloud)
- `empresa_nextcloud_accounts` almacena una fila por `empresa_id`, usuario tecnico,
  cuota en MB y estado de aprovisionamiento; no almacena contraseñas empresariales.
