...
| --- | --- | --- | --- |
| `/api/empresa/activos_fijos_niif_fiscal` | [backend/main.go:1780](../../backend/main.go#L1780) | `WithEmpresaActivosFijosNIIFPermissions` | protegida |
...
| `/api/empresa/auditoria/eventos` | [backend/main.go:1811](../../backend/main.go#L1811) | `WithEmpresaAuditoriaPermissions` | protegida |
| `/api/empresa/backups` | [backend/main.go:1800](../../backend/main.go#L1800) | `WithEmpresaBackupsPermissions` | protegida |
| `/api/empresa/bancos_pagos` | [backend/main.go:1787](../../backend/main.go#L1787) | `WithEmpresaBancosPagosPermissions` | protegida |
| `/api/empresa/bodegas` | [backend/main.go:1626](../../backend/main.go#L1626) | `WithEmpresaInventarioPermissions` | protegida |
| `/api/empresa/bolsa` | [backend/main.go:1753](../../backend/main.go#L1753) | `WithEmpresaBolsaPermissions` | protegida |
...
| `/api/empresa/calculadora` | [backend/main.go:1794](../../backend/main.go#L1794) | `WithEmpresaFinanzasPermissions` | protegida |
| `/api/empresa/calidad_procesos` | [backend/main.go:1789](../../backend/main.go#L1789) | `WithEmpresaCalidadProcesosPermissions` | protegida |
| `/api/empresa/camaras` | [backend/main.go:1752](../../backend/main.go#L1752) | `WithEmpresaCamarasPermissions` | protegida |
...
| `/api/empresa/centros_costo` | [backend/main.go:1781](../../backend/main.go#L1781) | `WithEmpresaCentrosCostoPermissions` | protegida |
...
| `/api/empresa/chat_tareas/archivo` | [backend/main.go:1756](../../backend/main.go#L1756) | `WithEmpresaChatTareasPermissions` | protegida |
| `/api/empresa/chat_tareas/citas` | [backend/main.go:1761](../../backend/main.go#L1761) | `WithEmpresaChatTareasPermissions` | protegida |
| `/api/empresa/chat_tareas/conversaciones` | [backend/main.go:1755](../../backend/main.go#L1755) | `WithEmpresaChatTareasPermissions` | protegida |
| `/api/empresa/chat_tareas/mensajes` | [backend/main.go:1758](../../backend/main.go#L1758) | `WithEmpresaChatTareasPermissions` | protegida |
| `/api/empresa/chat_tareas/mensajes/adjunto` | [backend/main.go:1759](../../backend/main.go#L1759) | `WithEmpresaChatTareasPermissions` | protegida |
| `/api/empresa/chat_tareas/papelera` | [backend/main.go:1763](../../backend/main.go#L1763) | `WithEmpresaChatTareasPermissions` | protegida |
| `/api/empresa/chat_tareas/participantes` | [backend/main.go:1757](../../backend/main.go#L1757) | `WithEmpresaChatTareasPermissions` | protegida |
| `/api/empresa/chat_tareas/tareas` | [backend/main.go:1760](../../backend/main.go#L1760) | `WithEmpresaChatTareasPermissions` | protegida |
| `/api/empresa/chat_tareas/tareas/nota_voz` | [backend/main.go:1762](../../backend/main.go#L1762) | `WithEmpresaChatTareasPermissions` | protegida |
| `/api/empresa/cierre_fiscal` | [backend/main.go:1782](../../backend/main.go#L1782) | `WithEmpresaCierreFiscalPermissions` | protegida |
| `/api/empresa/clientes` | [backend/main.go:1690](../../backend/main.go#L1690) | `WithEmpresaClientesPermissions` | protegida |
| `/api/empresa/cobranza` | [backend/main.go:1796](../../backend/main.go#L1796) | `WithEmpresaCobranzaPermissions` | protegida |
...
| `/api/empresa/contabilidad_colombia` | [backend/main.go:1778](../../backend/main.go#L1778) | `WithEmpresaContabilidadColombiaPermissions` | protegida |
| `/api/empresa/contabilidad_colombia_avanzada` | [backend/main.go:1779](../../backend/main.go#L1779) | `WithEmpresaContabilidadColombiaAvanzadaPermissions` | protegida |
...
| `/api/empresa/control_electrico` | [backend/main.go:1825](../../backend/main.go#L1825) | `WithEmpresaControlElectricoPermissions` | protegida |
| `/api/empresa/corte_caja` | [backend/main.go:1770](../../backend/main.go#L1770) | `WithEmpresaFinanzasPermissions` | protegida |
| `/api/empresa/corte_caja/configuracion` | [backend/main.go:1771](../../backend/main.go#L1771) | `WithEmpresaFinanzasPermissions` | protegida |
| `/api/empresa/creditos` | [backend/main.go:1795](../../backend/main.go#L1795) | `WithEmpresaFinanzasPermissions` | protegida |
...
| `/api/empresa/cumplimiento_kyc` | [backend/main.go:1788](../../backend/main.go#L1788) | `WithEmpresaCumplimientoKYCPermissions` | protegida |
...
| `/api/empresa/declaraciones_tributarias` | [backend/main.go:1783](../../backend/main.go#L1783) | `WithEmpresaDeclaracionesTributariasPermissions` | protegida |
| `/api/empresa/documentos` | [backend/main.go:1801](../../backend/main.go#L1801) | `WithEmpresaDocumentosOnlyOfficePermissions` | protegida |
...
| `/api/empresa/energia_solar` | [backend/main.go:1751](../../backend/main.go#L1751) | `WithEmpresaEnergiaSolarPermissions` | protegida |
...
| `/api/empresa/facturacion_electronica/contingencias` | [backend/main.go:1744](../../backend/main.go#L1744) | `WithEmpresaFacturacionPermissions` | protegida |
...
| `/api/empresa/facturacion_electronica/ecuador` | [backend/main.go:1745](../../backend/main.go#L1745) | `WithEmpresaFacturacionEcuadorPermissions` | protegida |
| `/api/empresa/facturacion_electronica/pais_detectado` | [backend/main.go:1747](../../backend/main.go#L1747) | `WithEmpresaFacturacionPermissions` | protegida |
| `/api/empresa/facturacion_electronica/paises_disponibles` | [backend/main.go:1748](../../backend/main.go#L1748) | `WithEmpresaFacturacionPermissions` | protegida |
| `/api/empresa/facturacion_electronica/panama` | [backend/main.go:1746](../../backend/main.go#L1746) | `WithEmpresaFacturacionPanamaPermissions` | protegida |
| `/api/empresa/finanzas/archivo` | [backend/main.go:1768](../../backend/main.go#L1768) | `WithEmpresaFinanzasPermissions` | protegida |
| `/api/empresa/finanzas/asientos_contables` | [backend/main.go:1776](../../backend/main.go#L1776) | `WithEmpresaFinanzasPermissions` | protegida |
| `/api/empresa/finanzas/breb_qr` | [backend/main.go:1774](../../backend/main.go#L1774) | `WithEmpresaFinanzasPermissions` | protegida |
| `/api/empresa/finanzas/cierres_caja` | [backend/main.go:1777](../../backend/main.go#L1777) | `WithEmpresaFinanzasPermissions` | protegida |
| `/api/empresa/finanzas/configuracion` | [backend/main.go:1772](../../backend/main.go#L1772) | `WithEmpresaFinanzasPermissions` | protegida |
...
| `/api/empresa/finanzas/movimientos` | [backend/main.go:1767](../../backend/main.go#L1767) | `WithEmpresaFinanzasPermissions` | protegida |
| `/api/empresa/finanzas/movimientos/comprobante` | [backend/main.go:1769](../../backend/main.go#L1769) | `WithEmpresaFinanzasPermissions` | protegida |
| `/api/empresa/finanzas/periodos` | [backend/main.go:1773](../../backend/main.go#L1773) | `WithEmpresaFinanzasPermissions` | protegida |
...
| `/api/empresa/finanzas/renta_ia` | [backend/main.go:1775](../../backend/main.go#L1775) | `WithEmpresaFinanzasPermissions` | protegida |
| `/api/empresa/frecuencia_fp/permitido` | [backend/main.go:1813](../../backend/main.go#L1813) | `WithEmpresaSeguridadPermissions` | protegida |
...
| `/api/empresa/hoja_vida_operativa` | [backend/main.go:1766](../../backend/main.go#L1766) | `WithEmpresaHojaVidaOperativaPermissions` | protegida |
...
| `/api/empresa/ia_empresarial` | [backend/main.go:1754](../../backend/main.go#L1754) | `WithEmpresaReportesPermissions` | protegida |
...
| `/api/empresa/impuestos` | [backend/main.go:1749](../../backend/main.go#L1749) | `WithEmpresaFacturacionPermissions` | protegida |
| `/api/empresa/impuestos/agente_internet` | [backend/main.go:1750](../../backend/main.go#L1750) | `WithEmpresaFacturacionPermissions` | protegida |
...
| `/api/empresa/mantenimiento_programado` | [backend/main.go:1908](../../backend/main.go#L1908) | `WithEmpresaSelfServicePermissions` | protegida |
| `/api/empresa/mi_horario` | [backend/main.go:1675](../../backend/main.go#L1675) | `WithEmpresaSelfServicePermissions` | protegida |
| `/api/empresa/nextcloud` | [backend/main.go:1802](../../backend/main.go#L1802) | `WithEmpresaGestionDocumentalPermissions` | protegida |
...
| `/api/empresa/permisos_contexto` | [backend/main.go:1827](../../backend/main.go#L1827) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/permisos_empresa` | [backend/main.go:1828](../../backend/main.go#L1828) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/plantillas_integracion/catalogo` | [backend/main.go:1786](../../backend/main.go#L1786) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/plantillas_nuevas/catalogo` | [backend/main.go:1785](../../backend/main.go#L1785) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/portal_contador` | [backend/main.go:1797](../../backend/main.go#L1797) | `WithEmpresaPortalContadorPermissions` | protegida |
| `/api/empresa/portal_terceros_certificados` | [backend/main.go:1798](../../backend/main.go#L1798) | `WithEmpresaPortalTercerosPermissions` | protegida |
...
| `/api/empresa/reportes` | [backend/main.go:1809](../../backend/main.go#L1809) | `WithEmpresaReportesPermissions` | protegida |
| `/api/empresa/reportes_ia_chat` | [backend/main.go:1810](../../backend/main.go#L1810) | `WithEmpresaReportesPermissions` | protegida |
| `/api/empresa/reservas_hotel` | [backend/main.go:1718](../../backend/main.go#L1718) | `WithEmpresaReservasHotelPermissions` | protegida |
| `/api/empresa/roles_de_usuario` | [backend/main.go:1826](../../backend/main.go#L1826) | `WithEmpresaSeguridadPermissions` | protegida |
...
| `/api/empresa/sensor_puertas` | [backend/main.go:1820](../../backend/main.go#L1820) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/sensor_puertas/messages` | [backend/main.go:1824](../../backend/main.go#L1824) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/servicios` | [backend/main.go:1666](../../backend/main.go#L1666) | `WithEmpresaInventarioPermissions` | protegida |
| `/api/empresa/soporte_remoto` | [backend/main.go:1808](../../backend/main.go#L1808) | `WithEmpresaSeguridadPermissions` | protegida |
...
| `/api/empresa/tesoreria_presupuesto` | [backend/main.go:1784](../../backend/main.go#L1784) | `WithEmpresaTesoreriaPresupuestoPermissions` | protegida |
...
| `/api/empresa/ubicacion_gps/dispositivos` | [backend/main.go:1764](../../backend/main.go#L1764) | `WithEmpresaUbicacionGPSPermissions` | protegida |
| `/api/empresa/ubicacion_gps/recorridos` | [backend/main.go:1765](../../backend/main.go#L1765) | `WithEmpresaUbicacionGPSPermissions` | protegida |
