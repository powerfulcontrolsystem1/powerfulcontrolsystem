...
- Rutas empresariales inventariadas: 196.
- Con wrapper autoritativo detectado: 196.
...
| `/api/empresa/aiu_construccion` | [backend/main.go:1659](../../backend/main.go#L1659) | `WithEmpresaAIUConstruccionPermissions` | protegida |
| `/api/empresa/alquileres` | [backend/main.go:1679](../../backend/main.go#L1679) | `WithEmpresaAlquileresPermissions` | protegida |
| `/api/empresa/asistencia_empleados` | [backend/main.go:1672](../../backend/main.go#L1672) | `WithEmpresaAsistenciaEmpleadosPermissions` | protegida |
...
| `/api/empresa/camaras` | [backend/main.go:1747](../../backend/main.go#L1747) | `WithEmpresaCamarasPermissions` | protegida |
| `/api/empresa/carnets` | [backend/main.go:1676](../../backend/main.go#L1676) | `WithEmpresaCarnetsPermissions` | protegida |
| `/api/empresa/carritos_compra` | [backend/main.go:1688](../../backend/main.go#L1688) | `WithEmpresaVentasPermissions` | protegida |
| `/api/empresa/carritos_compra/historial_productos` | [backend/main.go:1690](../../backend/main.go#L1690) | `WithEmpresaVentasPermissions` | protegida |
| `/api/empresa/carritos_compra/items` | [backend/main.go:1689](../../backend/main.go#L1689) | `WithEmpresaVentasPermissions` | protegida |
...
| `/api/empresa/clientes` | [backend/main.go:1686](../../backend/main.go#L1686) | `WithEmpresaClientesPermissions` | protegida |
| `/api/empresa/cobranza` | [backend/main.go:1791](../../backend/main.go#L1791) | `WithEmpresaCobranzaPermissions` | protegida |
| `/api/empresa/codigos_de_descuento` | [backend/main.go:1720](../../backend/main.go#L1720) | `WithEmpresaVentasPermissions` | protegida |
| `/api/empresa/comisiones` | [backend/main.go:1722](../../backend/main.go#L1722) | `WithEmpresaFinanzasPermissions` | protegida |
...
| `/api/empresa/configuracion_avanzada` | [backend/main.go:1725](../../backend/main.go#L1725) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/configuracion_avanzada/logo` | [backend/main.go:1726](../../backend/main.go#L1726) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/configuracion_general` | [backend/main.go:1723](../../backend/main.go#L1723) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/configuracion_guiada` | [backend/main.go:1727](../../backend/main.go#L1727) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/configuracion_ia_propia` | [backend/main.go:1728](../../backend/main.go#L1728) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/configuracion_operativa` | [backend/main.go:1724](../../backend/main.go#L1724) | `WithEmpresaSeguridadPermissions` | protegida |
...
| `/api/empresa/crm_avanzado` | [backend/main.go:1687](../../backend/main.go#L1687) | `WithEmpresaCRMUnificadoPermissions` | protegida |
...
| `/api/empresa/datafonos` | [backend/main.go:1692](../../backend/main.go#L1692) | `WithEmpresaVentasPermissions` | protegida |
| `/api/empresa/db_admin` | [backend/main.go:1733](../../backend/main.go#L1733) | `WithEmpresaSeguridadPermissions` | protegida |
...
| `/api/empresa/domicilios` | [backend/main.go:1677](../../backend/main.go#L1677) | `WithEmpresaDomiciliosPermissions` | protegida |
| `/api/empresa/email_corporativo` | [backend/main.go:1732](../../backend/main.go#L1732) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/energia_solar` | [backend/main.go:1746](../../backend/main.go#L1746) | `WithEmpresaEnergiaSolarPermissions` | protegida |
| `/api/empresa/estacion_aseo` | [backend/main.go:1738](../../backend/main.go#L1738) | `WithEmpresaSelfServicePermissions` | protegida |
| `/api/empresa/estacion_prefs` | [backend/main.go:1737](../../backend/main.go#L1737) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/facturacion_electronica` | [backend/main.go:1739](../../backend/main.go#L1739) | `WithEmpresaFacturacionPermissions` | protegida |
...
| `/api/empresa/facturacion_electronica/ecuador` | [backend/main.go:1740](../../backend/main.go#L1740) | `WithEmpresaFacturacionEcuadorPermissions` | protegida |
| `/api/empresa/facturacion_electronica/pais_detectado` | [backend/main.go:1742](../../backend/main.go#L1742) | `WithEmpresaFacturacionPermissions` | protegida |
| `/api/empresa/facturacion_electronica/paises_disponibles` | [backend/main.go:1743](../../backend/main.go#L1743) | `WithEmpresaFacturacionPermissions` | protegida |
| `/api/empresa/facturacion_electronica/panama` | [backend/main.go:1741](../../backend/main.go#L1741) | `WithEmpresaFacturacionPanamaPermissions` | protegida |
...
| `/api/empresa/horarios_trabajadores` | [backend/main.go:1670](../../backend/main.go#L1670) | `WithEmpresaHorariosTrabajadoresPermissions` | protegida |
| `/api/empresa/hotel_tarjetas_acceso` | [backend/main.go:1718](../../backend/main.go#L1718) | `WithEmpresaReservasHotelPermissions` | protegida |
...
| `/api/empresa/importaciones_costeo` | [backend/main.go:1658](../../backend/main.go#L1658) | `WithEmpresaImportacionesCosteoPermissions` | protegida |
| `/api/empresa/impresoras` | [backend/main.go:1734](../../backend/main.go#L1734) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/impresoras/agente` | [backend/main.go:1735](../../backend/main.go#L1735) | `WithEmpresaVentasPermissions` | protegida |
| `/api/empresa/impresoras/resolver` | [backend/main.go:1736](../../backend/main.go#L1736) | `WithEmpresaVentasPermissions` | protegida |
| `/api/empresa/impuestos` | [backend/main.go:1744](../../backend/main.go#L1744) | `WithEmpresaFacturacionPermissions` | protegida |
| `/api/empresa/impuestos/agente_internet` | [backend/main.go:1745](../../backend/main.go#L1745) | `WithEmpresaFacturacionPermissions` | protegida |
...
| `/api/empresa/licencia_sistema/pdf` | [backend/main.go:1730](../../backend/main.go#L1730) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/licencias/comprobantes` | [backend/main.go:1731](../../backend/main.go#L1731) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/logistica_wms` | [backend/main.go:1661](../../backend/main.go#L1661) | `WithEmpresaWMSPermissions` | protegida |
...
| `/api/empresa/mi_horario` | [backend/main.go:1671](../../backend/main.go#L1671) | `WithEmpresaSelfServicePermissions` | protegida |
| `/api/empresa/nextcloud` | [backend/main.go:1797](../../backend/main.go#L1797) | `WithEmpresaGestionDocumentalPermissions` | protegida |
| `/api/empresa/nomina` | [backend/main.go:1673](../../backend/main.go#L1673) | `WithEmpresaNominaSueldosPermissions` | protegida |
| `/api/empresa/nomina/agente_internet` | [backend/main.go:1674](../../backend/main.go#L1674) | `WithEmpresaNominaSueldosPermissions` | protegida |
| `/api/empresa/noticias` | [backend/main.go:1656](../../backend/main.go#L1656) | `WithEmpresaSelfServicePermissions` | protegida |
| `/api/empresa/offline_ventas` | [backend/main.go:1691](../../backend/main.go#L1691) | `WithEmpresaVentasPermissions` | protegida |
| `/api/empresa/panel_configuracion` | [backend/main.go:1729](../../backend/main.go#L1729) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/parqueadero` | [backend/main.go:1678](../../backend/main.go#L1678) | `WithEmpresaParqueaderoPermissions` | protegida |
...
| `/api/empresa/produccion_mrp` | [backend/main.go:1660](../../backend/main.go#L1660) | `WithEmpresaProduccionMRPPermissions` | protegida |
...
| `/api/empresa/propinas` | [backend/main.go:1721](../../backend/main.go#L1721) | `WithEmpresaFinanzasPermissions` | protegida |
| `/api/empresa/proveedores` | [backend/main.go:1657](../../backend/main.go#L1657) | `WithEmpresaComprasPermissions` | protegida |
| `/api/empresa/publicaciones` | [backend/main.go:1681](../../backend/main.go#L1681) | `WithEmpresaVentasPermissions` | protegida |
| `/api/empresa/publicaciones/` | [backend/main.go:1682](../../backend/main.go#L1682) | `WithEmpresaVentasPermissions` | protegida |
| `/api/empresa/rappi` | [backend/main.go:1694](../../backend/main.go#L1694) | `WithEmpresaVentaPublicaPermissions` | protegida |
...
| `/api/empresa/reservas_hotel` | [backend/main.go:1714](../../backend/main.go#L1714) | `WithEmpresaReservasHotelPermissions` | protegida |
...
| `/api/empresa/servicios` | [backend/main.go:1662](../../backend/main.go#L1662) | `WithEmpresaInventarioPermissions` | protegida |
...
| `/api/empresa/tarifas_motel` | [backend/main.go:1717](../../backend/main.go#L1717) | `WithEmpresaVentasPermissions` | protegida |
| `/api/empresa/tarifas_por_dia` | [backend/main.go:1716](../../backend/main.go#L1716) | `WithEmpresaVentasPermissions` | protegida |
| `/api/empresa/tarifas_por_minutos` | [backend/main.go:1715](../../backend/main.go#L1715) | `WithEmpresaVentasPermissions` | protegida |
...
| `/api/empresa/turnos_atencion` | [backend/main.go:1680](../../backend/main.go#L1680) | `WithEmpresaTurnosAtencionPermissions` | protegida |
...
| `/api/empresa/usuarios` | [backend/main.go:1669](../../backend/main.go#L1669) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/usuarios/cambiar_password` | [backend/main.go:1668](../../backend/main.go#L1668) | `WithEmpresaPublicScope` | protegida |
| `/api/empresa/usuarios/establecer_password` | [backend/main.go:1664](../../backend/main.go#L1664) | `WithEmpresaPublicScope` | protegida |
| `/api/empresa/usuarios/login` | [backend/main.go:1663](../../backend/main.go#L1663) | `WithEmpresaPublicScope` | protegida |
| `/api/empresa/usuarios/recuperar_invitacion` | [backend/main.go:1665](../../backend/main.go#L1665) | `WithEmpresaPublicScope` | protegida |
| `/api/empresa/usuarios/restablecer_password` | [backend/main.go:1667](../../backend/main.go#L1667) | `WithEmpresaPublicScope` | protegida |
| `/api/empresa/usuarios/solicitar_recuperacion_password` | [backend/main.go:1666](../../backend/main.go#L1666) | `WithEmpresaPublicScope` | protegida |
| `/api/empresa/vehiculos_registro` | [backend/main.go:1675](../../backend/main.go#L1675) | `WithEmpresaVehiculosRegistroPermissions` | protegida |
| `/api/empresa/venta_publica` | [backend/main.go:1693](../../backend/main.go#L1693) | `WithEmpresaVentaPublicaPermissions` | protegida |
...
| Ruta | Wrapper | Actor y alcance | IDs secundarios | Archivos / efectos |
|---|---|---|---|---|
| `/api/empresa/vida` | `WithEmpresaVidaPermissions` | Sesion y rol empresarial; `empresa_id` validado y `usuario_id` derivado del correo autenticado | Gastos y suscripciones siempre se resuelven por `empresa_id + usuario_id + id` | Comprobantes privados JPEG/PNG/WebP/PDF; no crea contabilidad, caja, inventario ni llamadas externas |
