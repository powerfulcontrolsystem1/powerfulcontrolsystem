...
| --- | --- | --- | --- |
| `/api/empresa/activos_fijos_niif_fiscal` | [backend/main.go:1776](../../backend/main.go#L1776) | `WithEmpresaActivosFijosNIIFPermissions` | protegida |
...
| `/api/empresa/alquileres` | [backend/main.go:1680](../../backend/main.go#L1680) | `WithEmpresaAlquileresPermissions` | protegida |
...
| `/api/empresa/auditoria/eventos` | [backend/main.go:1807](../../backend/main.go#L1807) | `WithEmpresaAuditoriaPermissions` | protegida |
| `/api/empresa/backups` | [backend/main.go:1796](../../backend/main.go#L1796) | `WithEmpresaBackupsPermissions` | protegida |
| `/api/empresa/bancos_pagos` | [backend/main.go:1783](../../backend/main.go#L1783) | `WithEmpresaBancosPagosPermissions` | protegida |
| `/api/empresa/bodegas` | [backend/main.go:1623](../../backend/main.go#L1623) | `WithEmpresaInventarioPermissions` | protegida |
| `/api/empresa/bolsa` | [backend/main.go:1749](../../backend/main.go#L1749) | `WithEmpresaBolsaPermissions` | protegida |
...
| `/api/empresa/calculadora` | [backend/main.go:1790](../../backend/main.go#L1790) | `WithEmpresaFinanzasPermissions` | protegida |
| `/api/empresa/calidad_procesos` | [backend/main.go:1785](../../backend/main.go#L1785) | `WithEmpresaCalidadProcesosPermissions` | protegida |
| `/api/empresa/camaras` | [backend/main.go:1748](../../backend/main.go#L1748) | `WithEmpresaCamarasPermissions` | protegida |
| `/api/empresa/carnets` | [backend/main.go:1677](../../backend/main.go#L1677) | `WithEmpresaCarnetsPermissions` | protegida |
| `/api/empresa/carritos_compra` | [backend/main.go:1689](../../backend/main.go#L1689) | `WithEmpresaVentasPermissions` | protegida |
| `/api/empresa/carritos_compra/historial_productos` | [backend/main.go:1691](../../backend/main.go#L1691) | `WithEmpresaVentasPermissions` | protegida |
| `/api/empresa/carritos_compra/items` | [backend/main.go:1690](../../backend/main.go#L1690) | `WithEmpresaVentasPermissions` | protegida |
| `/api/empresa/categorias_productos` | [backend/main.go:1624](../../backend/main.go#L1624) | `WithEmpresaInventarioPermissions` | protegida |
| `/api/empresa/centros_costo` | [backend/main.go:1777](../../backend/main.go#L1777) | `WithEmpresaCentrosCostoPermissions` | protegida |
...
| `/api/empresa/chat_tareas/archivo` | [backend/main.go:1752](../../backend/main.go#L1752) | `WithEmpresaChatTareasPermissions` | protegida |
| `/api/empresa/chat_tareas/citas` | [backend/main.go:1757](../../backend/main.go#L1757) | `WithEmpresaChatTareasPermissions` | protegida |
| `/api/empresa/chat_tareas/conversaciones` | [backend/main.go:1751](../../backend/main.go#L1751) | `WithEmpresaChatTareasPermissions` | protegida |
| `/api/empresa/chat_tareas/mensajes` | [backend/main.go:1754](../../backend/main.go#L1754) | `WithEmpresaChatTareasPermissions` | protegida |
| `/api/empresa/chat_tareas/mensajes/adjunto` | [backend/main.go:1755](../../backend/main.go#L1755) | `WithEmpresaChatTareasPermissions` | protegida |
| `/api/empresa/chat_tareas/papelera` | [backend/main.go:1759](../../backend/main.go#L1759) | `WithEmpresaChatTareasPermissions` | protegida |
| `/api/empresa/chat_tareas/participantes` | [backend/main.go:1753](../../backend/main.go#L1753) | `WithEmpresaChatTareasPermissions` | protegida |
| `/api/empresa/chat_tareas/tareas` | [backend/main.go:1756](../../backend/main.go#L1756) | `WithEmpresaChatTareasPermissions` | protegida |
| `/api/empresa/chat_tareas/tareas/nota_voz` | [backend/main.go:1758](../../backend/main.go#L1758) | `WithEmpresaChatTareasPermissions` | protegida |
| `/api/empresa/cierre_fiscal` | [backend/main.go:1778](../../backend/main.go#L1778) | `WithEmpresaCierreFiscalPermissions` | protegida |
| `/api/empresa/clientes` | [backend/main.go:1687](../../backend/main.go#L1687) | `WithEmpresaClientesPermissions` | protegida |
| `/api/empresa/cobranza` | [backend/main.go:1792](../../backend/main.go#L1792) | `WithEmpresaCobranzaPermissions` | protegida |
| `/api/empresa/codigos_de_descuento` | [backend/main.go:1721](../../backend/main.go#L1721) | `WithEmpresaVentasPermissions` | protegida |
| `/api/empresa/comisiones` | [backend/main.go:1723](../../backend/main.go#L1723) | `WithEmpresaFinanzasPermissions` | protegida |
...
| `/api/empresa/configuracion_avanzada` | [backend/main.go:1726](../../backend/main.go#L1726) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/configuracion_avanzada/logo` | [backend/main.go:1727](../../backend/main.go#L1727) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/configuracion_general` | [backend/main.go:1724](../../backend/main.go#L1724) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/configuracion_guiada` | [backend/main.go:1728](../../backend/main.go#L1728) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/configuracion_ia_propia` | [backend/main.go:1729](../../backend/main.go#L1729) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/configuracion_operativa` | [backend/main.go:1725](../../backend/main.go#L1725) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/contabilidad_colombia` | [backend/main.go:1774](../../backend/main.go#L1774) | `WithEmpresaContabilidadColombiaPermissions` | protegida |
| `/api/empresa/contabilidad_colombia_avanzada` | [backend/main.go:1775](../../backend/main.go#L1775) | `WithEmpresaContabilidadColombiaAvanzadaPermissions` | protegida |
...
| `/api/empresa/control_electrico` | [backend/main.go:1821](../../backend/main.go#L1821) | `WithEmpresaControlElectricoPermissions` | protegida |
| `/api/empresa/corte_caja` | [backend/main.go:1766](../../backend/main.go#L1766) | `WithEmpresaFinanzasPermissions` | protegida |
| `/api/empresa/corte_caja/configuracion` | [backend/main.go:1767](../../backend/main.go#L1767) | `WithEmpresaFinanzasPermissions` | protegida |
| `/api/empresa/creditos` | [backend/main.go:1791](../../backend/main.go#L1791) | `WithEmpresaFinanzasPermissions` | protegida |
| `/api/empresa/crm_avanzado` | [backend/main.go:1688](../../backend/main.go#L1688) | `WithEmpresaCRMUnificadoPermissions` | protegida |
...
| `/api/empresa/cumplimiento_kyc` | [backend/main.go:1784](../../backend/main.go#L1784) | `WithEmpresaCumplimientoKYCPermissions` | protegida |
| `/api/empresa/datafonos` | [backend/main.go:1693](../../backend/main.go#L1693) | `WithEmpresaVentasPermissions` | protegida |
| `/api/empresa/db_admin` | [backend/main.go:1734](../../backend/main.go#L1734) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/declaraciones_tributarias` | [backend/main.go:1779](../../backend/main.go#L1779) | `WithEmpresaDeclaracionesTributariasPermissions` | protegida |
| `/api/empresa/documentos` | [backend/main.go:1797](../../backend/main.go#L1797) | `WithEmpresaDocumentosOnlyOfficePermissions` | protegida |
...
| `/api/empresa/domicilios` | [backend/main.go:1678](../../backend/main.go#L1678) | `WithEmpresaDomiciliosPermissions` | protegida |
| `/api/empresa/email_corporativo` | [backend/main.go:1733](../../backend/main.go#L1733) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/energia_solar` | [backend/main.go:1747](../../backend/main.go#L1747) | `WithEmpresaEnergiaSolarPermissions` | protegida |
| `/api/empresa/estacion_aseo` | [backend/main.go:1739](../../backend/main.go#L1739) | `WithEmpresaSelfServicePermissions` | protegida |
| `/api/empresa/estacion_prefs` | [backend/main.go:1738](../../backend/main.go#L1738) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/facturacion_electronica` | [backend/main.go:1740](../../backend/main.go#L1740) | `WithEmpresaFacturacionPermissions` | protegida |
...
| `/api/empresa/facturacion_electronica/ecuador` | [backend/main.go:1741](../../backend/main.go#L1741) | `WithEmpresaFacturacionEcuadorPermissions` | protegida |
| `/api/empresa/facturacion_electronica/pais_detectado` | [backend/main.go:1743](../../backend/main.go#L1743) | `WithEmpresaFacturacionPermissions` | protegida |
| `/api/empresa/facturacion_electronica/paises_disponibles` | [backend/main.go:1744](../../backend/main.go#L1744) | `WithEmpresaFacturacionPermissions` | protegida |
| `/api/empresa/facturacion_electronica/panama` | [backend/main.go:1742](../../backend/main.go#L1742) | `WithEmpresaFacturacionPanamaPermissions` | protegida |
| `/api/empresa/finanzas/archivo` | [backend/main.go:1764](../../backend/main.go#L1764) | `WithEmpresaFinanzasPermissions` | protegida |
| `/api/empresa/finanzas/asientos_contables` | [backend/main.go:1772](../../backend/main.go#L1772) | `WithEmpresaFinanzasPermissions` | protegida |
| `/api/empresa/finanzas/breb_qr` | [backend/main.go:1770](../../backend/main.go#L1770) | `WithEmpresaFinanzasPermissions` | protegida |
| `/api/empresa/finanzas/cierres_caja` | [backend/main.go:1773](../../backend/main.go#L1773) | `WithEmpresaFinanzasPermissions` | protegida |
| `/api/empresa/finanzas/configuracion` | [backend/main.go:1768](../../backend/main.go#L1768) | `WithEmpresaFinanzasPermissions` | protegida |
...
| `/api/empresa/finanzas/movimientos` | [backend/main.go:1763](../../backend/main.go#L1763) | `WithEmpresaFinanzasPermissions` | protegida |
| `/api/empresa/finanzas/movimientos/comprobante` | [backend/main.go:1765](../../backend/main.go#L1765) | `WithEmpresaFinanzasPermissions` | protegida |
| `/api/empresa/finanzas/periodos` | [backend/main.go:1769](../../backend/main.go#L1769) | `WithEmpresaFinanzasPermissions` | protegida |
...
| `/api/empresa/finanzas/renta_ia` | [backend/main.go:1771](../../backend/main.go#L1771) | `WithEmpresaFinanzasPermissions` | protegida |
| `/api/empresa/frecuencia_fp/permitido` | [backend/main.go:1809](../../backend/main.go#L1809) | `WithEmpresaSeguridadPermissions` | protegida |
...
| `/api/empresa/hoja_vida_operativa` | [backend/main.go:1762](../../backend/main.go#L1762) | `WithEmpresaHojaVidaOperativaPermissions` | protegida |
...
| `/api/empresa/hotel_tarjetas_acceso` | [backend/main.go:1719](../../backend/main.go#L1719) | `WithEmpresaReservasHotelPermissions` | protegida |
| `/api/empresa/ia_empresarial` | [backend/main.go:1750](../../backend/main.go#L1750) | `WithEmpresaReportesPermissions` | protegida |
...
| `/api/empresa/impresoras` | [backend/main.go:1735](../../backend/main.go#L1735) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/impresoras/agente` | [backend/main.go:1736](../../backend/main.go#L1736) | `WithEmpresaVentasPermissions` | protegida |
| `/api/empresa/impresoras/resolver` | [backend/main.go:1737](../../backend/main.go#L1737) | `WithEmpresaVentasPermissions` | protegida |
| `/api/empresa/impuestos` | [backend/main.go:1745](../../backend/main.go#L1745) | `WithEmpresaFacturacionPermissions` | protegida |
| `/api/empresa/impuestos/agente_internet` | [backend/main.go:1746](../../backend/main.go#L1746) | `WithEmpresaFacturacionPermissions` | protegida |
...
| `/api/empresa/licencia_sistema/pdf` | [backend/main.go:1731](../../backend/main.go#L1731) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/licencias/comprobantes` | [backend/main.go:1732](../../backend/main.go#L1732) | `WithEmpresaSeguridadPermissions` | protegida |
...
| `/api/empresa/mantenimiento_programado` | [backend/main.go:1903](../../backend/main.go#L1903) | `WithEmpresaSelfServicePermissions` | protegida |
| `/api/empresa/mi_horario` | [backend/main.go:1672](../../backend/main.go#L1672) | `WithEmpresaSelfServicePermissions` | protegida |
| `/api/empresa/nextcloud` | [backend/main.go:1798](../../backend/main.go#L1798) | `WithEmpresaGestionDocumentalPermissions` | protegida |
...
| `/api/empresa/noticias` | [backend/main.go:1657](../../backend/main.go#L1657) | `WithEmpresaSelfServicePermissions` | protegida |
| `/api/empresa/offline_ventas` | [backend/main.go:1692](../../backend/main.go#L1692) | `WithEmpresaVentasPermissions` | protegida |
| `/api/empresa/panel_configuracion` | [backend/main.go:1730](../../backend/main.go#L1730) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/parqueadero` | [backend/main.go:1679](../../backend/main.go#L1679) | `WithEmpresaParqueaderoPermissions` | protegida |
| `/api/empresa/permisos_contexto` | [backend/main.go:1823](../../backend/main.go#L1823) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/permisos_empresa` | [backend/main.go:1824](../../backend/main.go#L1824) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/plantillas_integracion/catalogo` | [backend/main.go:1782](../../backend/main.go#L1782) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/plantillas_nuevas/catalogo` | [backend/main.go:1781](../../backend/main.go#L1781) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/portal_contador` | [backend/main.go:1793](../../backend/main.go#L1793) | `WithEmpresaPortalContadorPermissions` | protegida |
| `/api/empresa/portal_terceros_certificados` | [backend/main.go:1794](../../backend/main.go#L1794) | `WithEmpresaPortalTercerosPermissions` | protegida |
...
| `/api/empresa/propinas` | [backend/main.go:1722](../../backend/main.go#L1722) | `WithEmpresaFinanzasPermissions` | protegida |
| `/api/empresa/proveedores` | [backend/main.go:1658](../../backend/main.go#L1658) | `WithEmpresaComprasPermissions` | protegida |
| `/api/empresa/publicaciones` | [backend/main.go:1682](../../backend/main.go#L1682) | `WithEmpresaVentasPermissions` | protegida |
| `/api/empresa/publicaciones/` | [backend/main.go:1683](../../backend/main.go#L1683) | `WithEmpresaVentasPermissions` | protegida |
| `/api/empresa/rappi` | [backend/main.go:1695](../../backend/main.go#L1695) | `WithEmpresaVentaPublicaPermissions` | protegida |
| `/api/empresa/recetas_productos` | [backend/main.go:1626](../../backend/main.go#L1626) | `WithEmpresaInventarioPermissions` | protegida |
| `/api/empresa/reportes` | [backend/main.go:1805](../../backend/main.go#L1805) | `WithEmpresaReportesPermissions` | protegida |
| `/api/empresa/reportes_ia_chat` | [backend/main.go:1806](../../backend/main.go#L1806) | `WithEmpresaReportesPermissions` | protegida |
| `/api/empresa/reservas_hotel` | [backend/main.go:1715](../../backend/main.go#L1715) | `WithEmpresaReservasHotelPermissions` | protegida |
| `/api/empresa/roles_de_usuario` | [backend/main.go:1822](../../backend/main.go#L1822) | `WithEmpresaSeguridadPermissions` | protegida |
...
| `/api/empresa/sensor_puertas` | [backend/main.go:1816](../../backend/main.go#L1816) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/sensor_puertas/messages` | [backend/main.go:1820](../../backend/main.go#L1820) | `WithEmpresaSeguridadPermissions` | protegida |
| `/api/empresa/servicios` | [backend/main.go:1663](../../backend/main.go#L1663) | `WithEmpresaInventarioPermissions` | protegida |
| `/api/empresa/soporte_remoto` | [backend/main.go:1804](../../backend/main.go#L1804) | `WithEmpresaSeguridadPermissions` | protegida |
...
| `/api/empresa/tarifas_motel` | [backend/main.go:1718](../../backend/main.go#L1718) | `WithEmpresaVentasPermissions` | protegida |
| `/api/empresa/tarifas_por_dia` | [backend/main.go:1717](../../backend/main.go#L1717) | `WithEmpresaVentasPermissions` | protegida |
| `/api/empresa/tarifas_por_minutos` | [backend/main.go:1716](../../backend/main.go#L1716) | `WithEmpresaVentasPermissions` | protegida |
| `/api/empresa/tesoreria_presupuesto` | [backend/main.go:1780](../../backend/main.go#L1780) | `WithEmpresaTesoreriaPresupuestoPermissions` | protegida |
| `/api/empresa/tickets_ayuda` | [backend/main.go:1653](../../backend/main.go#L1653) | `WithEmpresaSelfServicePermissions` | protegida |
| `/api/empresa/turnos_atencion` | [backend/main.go:1681](../../backend/main.go#L1681) | `WithEmpresaTurnosAtencionPermissions` | protegida |
| `/api/empresa/ubicacion_gps/dispositivos` | [backend/main.go:1760](../../backend/main.go#L1760) | `WithEmpresaUbicacionGPSPermissions` | protegida |
| `/api/empresa/ubicacion_gps/recorridos` | [backend/main.go:1761](../../backend/main.go#L1761) | `WithEmpresaUbicacionGPSPermissions` | protegida |
...
| `/api/empresa/venta_publica` | [backend/main.go:1694](../../backend/main.go#L1694) | `WithEmpresaVentaPublicaPermissions` | protegida |
...
| `/api/empresa/vida` | [backend/main.go:1656](../../backend/main.go#L1656) | `WithEmpresaVidaPermissions` | protegida |
