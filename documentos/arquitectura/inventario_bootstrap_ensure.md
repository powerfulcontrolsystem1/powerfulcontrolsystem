...
| `EnsureEmpresaControlElectricoPrimaryRaspberry` | [backend/db/control_electrico.go:550](../../backend/db/control_electrico.go#L550) | regla auxiliar o verificacion | empresas o por confirmar |
