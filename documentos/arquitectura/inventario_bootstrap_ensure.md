...
| `EnsureCorporateEmailConfigFromEnv` | [backend/handlers/email_corporativo_handlers.go:280](../../backend/handlers/email_corporativo_handlers.go#L280) | provisionamiento de integracion | empresas o por confirmar |
