...
| `EnsureEmpresaAIConversation` | [backend/db/ai_enterprise.go:192](../../backend/db/ai_enterprise.go#L192) | seed o provisionamiento idempotente | empresas o por confirmar |
...
| `EnsureSuperContractSchema` | [backend/db/contrato_super.go:132](../../backend/db/contrato_super.go#L132) | DDL / indice / funcion | superadministrador o por confirmar |
| `EnsureDefaultSuperContract` | [backend/db/contrato_super.go:230](../../backend/db/contrato_super.go#L230) | seed o provisionamiento idempotente | superadministrador o por confirmar |
...
| `EnsureEmpresaConfiguracionAvanzadaSchema` | [backend/db/empresa_configuracion_avanzada.go:106](../../backend/db/empresa_configuracion_avanzada.go#L106) | DDL / indice / funcion | empresas o por confirmar |
...
| `EnsureEmpresaImpresorasSchema` | [backend/db/empresa_impresoras.go:167](../../backend/db/empresa_impresoras.go#L167) | DDL / indice / funcion | empresas o por confirmar |
| `EnsureEmpresaPOS80Defaults` | [backend/db/empresa_impresoras.go:874](../../backend/db/empresa_impresoras.go#L874) | seed o provisionamiento idempotente | empresas o por confirmar |
| `EnsureAllEmpresasPOS80Defaults` | [backend/db/empresa_impresoras.go:949](../../backend/db/empresa_impresoras.go#L949) | seed o provisionamiento idempotente | empresas o por confirmar |
...
| `EnsureEmpresaFacturacionElectronicaSchema` | [backend/db/facturacion_electronica.go:319](../../backend/db/facturacion_electronica.go#L319) | DDL / indice / funcion | empresas o por confirmar |
| `EnsureEmpresaFinanzasSchema` | [backend/db/finanzas.go:170](../../backend/db/finanzas.go#L170) | DDL / indice / funcion | empresas o por confirmar |
