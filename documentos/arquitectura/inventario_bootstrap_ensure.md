...
- Huella del catalogo legado: `b8e2c6f0f9cadcb58e39b77ff5132a7caba2d57ba5078fc6b5c4445b345bc912` (122 pasos).
...
| `EnsureEmpresaControlElectricoPrimaryRaspberry` | [backend/db/control_electrico.go:514](../../backend/db/control_electrico.go#L514) | regla auxiliar o verificacion | empresas o por confirmar |
...
| `EnsureEmpresaReportesProgramacionSchema` | [backend/db/reportes_programacion.go:38](../../backend/db/reportes_programacion.go#L38) | DDL / indice / funcion | empresas o por confirmar |
