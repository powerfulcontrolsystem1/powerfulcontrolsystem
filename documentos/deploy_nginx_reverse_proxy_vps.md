...
Las migraciones de mayo, rutas de backup y vhosts anteriores permanecen en la
[referencia histórica](historico/2026-09-05/deploy_nginx_reverse_proxy_vps_referencia_acumulada.md).
No son una descripción verificada del servidor actual.
