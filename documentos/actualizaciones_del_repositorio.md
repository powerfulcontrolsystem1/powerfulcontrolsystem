...
2026-08-21 02:45:43 - Mensaje: fix: endurecer facturacion electronica DIAN para produccion; Commit: 82e27083; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/cmd/pcs-worker/business_registry.go
- backend/cmd/pcs-worker/business_registry_test.go
- backend/db/documentos_transaccionales.go
- backend/db/facturacion_artefactos.go
- backend/db/facturacion_documentos_money_precision.go
- backend/db/facturacion_electronica.go
- backend/db/facturacion_electronica_paises_test.go
- backend/db/facturacion_electronica_postgres_test.go
- backend/db/legacy_schema_catalog_manifest_generated.go
- backend/db/platform_migrations.go
- backend/handlers/dian_signature_upload_test.go
...
- backend/handlers/facturacion_documentos_electronicos_test.go
- backend/handlers/facturacion_electronica.go
- backend/handlers/facturacion_electronica_boundary_test.go
- backend/handlers/modulos_faltantes.go
- backend/handlers/nomina_sueldos.go
...
2026-09-06 10:52:10 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 13995ec0; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/cmd/pcs-worker/business_registry.go
- backend/db/queue_capacity.go
- backend/handlers/client_ip_security_test.go
- backend/handlers/empresa_permisos.go
- backend/handlers/empresa_rate_limit_test.go
- backend/handlers/facturacion_electronica.go
- backend/handlers/public_chat_portal.go
- backend/main_metrics_test.go
- backend/utils/security_headers_test.go
- deploy/.env.platform.example
- deploy/docker-compose.platform.yml
- deploy/nginx/edge-http-only.conf.template
...
- deploy/scripts/vps-configure-staging-nginx.sh
- deploy/scripts/vps-hardening-audit.sh
- deploy/scripts/vps-http-hardening.py
- deploy/scripts/vps-ssh-hardening.sh
- documentos/CHANGELOG.md
- documentos/arquitectura/capacidad_colas_multiempresa.md
- documentos/arquitectura/descripcion_arquitectura.md
- documentos/catalogo_documental.json
- documentos/catalogo_documental.md
- documentos/contexto_general_del_sistema.md
- documentos/descripcion_de_archivos
- documentos/descripcion_de_modulos
- documentos/diagramas/diagrama_entidad_relacion.md
...
- documentos/historial_de_cambios
- documentos/mapa_modulos.md
- documentos/observability_runbook.md
- tools/qa_queue_capacity_ui.cjs
- tools/vps_hardening_audit.mjs
