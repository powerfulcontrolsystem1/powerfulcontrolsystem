...
2026-05-12 23:36:16 - Mensaje: seguridad vps cambiar ssh a 49222; Commit: bce47375; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/.env.example
- backend/handlers/super_servidores_handlers.go
- backend/vpssecurity/config/config.go
- backend/vpssecurity/config/default_vps_security_config.json
- backend/vpssecurity/scanner/runner.go
- documentos/CHANGELOG.md
- documentos/descripcion_de_archivos
- documentos/descripcion_de_modulos
- documentos/gobernanza_tecnica/runbooks/runbook_arranque_postgresql_tunel_local.md
...
2026-05-13 05:06:01 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 8c832737; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/alquileres.go
- backend/db/alquileres_bootstrap.go
...
- backend/db/finanzas.go
- backend/db/gimnasio.go
- backend/db/licencias_vencimiento_notificaciones.go
- backend/db/nuevos_verticales_bootstrap.go
- backend/db/odontologia.go
- backend/db/parqueadero.go
- backend/db/propiedad_horizontal.go
- backend/db/propinas.go
- backend/db/super_correos_masivos.go
- backend/db/taxi_system.go
- backend/db/tickets_ayuda.go
- backend/db/tickets_ayuda_test.go
- backend/db/usuarios_empresa.go
- backend/handlers/carritos_compras.go
...
- backend/handlers/licencias_vencimiento_alertas.go
- backend/handlers/licencias_vencimiento_alertas_test.go
- backend/handlers/onlyoffice.go
- backend/handlers/payments_handlers.go
- backend/handlers/propinas.go
- backend/handlers/super_correos_masivos.go
- backend/handlers/super_email_templates.go
...
- documentos/diagramas/diagrama_entidad_relacion.png
- documentos/diagramas/diagrama_entidad_relacion.svg
- documentos/diagramas/docker_vps_estructura.svg
- documentos/diagramas/estructura_del_codigo.md
- documentos/estado_documentacion_2026-05-13.md
- documentos/estructura_bd.md
- documentos/historial_de_cambios
- documentos/matriz_roles_permisos_pos_multiempresa.md
- tmp/carrito_mock.png
- tmp/carrito_mock_after_fix.png
- tmp/carrito_prod_probe.png
- tmp/estacion_carrito_after_pay.png
- tmp/estacion_carrito_before_pay.png
- tmp/estaciones_caja_after_click.png
- tmp/estaciones_caja_before_click.png
- tmp/venta_directa_mock.png
- tmp/venta_directa_mock_after_fix.png
- tmp/venta_directa_prod_probe.png
- web/administrar_empresa.html
- web/administrar_empresa/auditoria.html
- web/administrar_empresa/carrito_de_compras.html
- web/administrar_empresa/comisiones.html
...
- web/ayuda/ayuda.html
- web/estilos.css
- web/img/login-admin-executive-dashboard.svg
- web/img/login-usuario-computador.svg
- web/index.html
- web/js/egresos_ingresos.js
- web/js/login_usuario.js
- web/js/print_documents.js
...
- web/menu.js
- web/super/configuracion_avanzada.html
- web/super/correos_masivos.html
- web/super/explorador_archivos.html
- web/super/licencias.html
- web/super/tickets_ayuda.html
- web/super_administrador.html
...
2026-05-13 06:41:19 - Mensaje: fix: validar estaciones carritos caja; Commit: e02e105f; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- documentos/CHANGELOG.md
- documentos/descripcion_de_modulos
- documentos/historial_de_cambios
- tmp/visual_caja_corte.png
- tmp/visual_estacion_carrito_abierto.png
- tmp/visual_estacion_despues_pago.png
- tmp/visual_estaciones_inicio.png
- web/administrar_empresa/carrito_de_compras.html
- web/administrar_empresa/estaciones.html
- web/estilos.css

2026-05-13 15:50:33 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 3fb4a423; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/carritos_compras.go
- backend/db/carritos_compras_schema_test.go
- backend/handlers/carritos_compras.go
- backend/handlers/facturacion_documentos_electronicos_test.go
- backend/handlers/facturacion_electronica.go
- backend/main.go
...
- web/administrar_empresa/facturacion_electronica_menu.html
- web/administrar_empresa/panel.html
- web/administrar_empresa/proveedores_firma_digital.html
- web/ayuda/ayuda.html
- web/img/juegos/asteroids_arcade.png
- web/img/juegos/breakout_arcade.png
- web/img/juegos/cube_runner_3d.png
- web/img/juegos/emulator.png
...
- web/img/juegos/space_dock_3d.png
- web/img/juegos/space_invaders.png
- web/img/juegos/tetris_arcade.png
- web/uploads/empresa_logos/empresa_32/gimnasio-el-bollon-logo.svg
- web/uploads/empresa_logos/empresa_7/motel-calipso-logo.svg

2026-05-13 18:31:36 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: dd959478; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/empresa_estacion_aseo.go
- backend/db/usuarios_empresa.go
- backend/handlers/corte_caja.go
- backend/handlers/empresa_estacion_aseo.go
- backend/handlers/empresa_estacion_prefs.go
- backend/handlers/empresa_preconfiguracion.go
- backend/handlers/onlyoffice.go
...
- web/administrar_empresa/reporte_aseo_estaciones.html
...
2026-05-13 20:00:59 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 5f087912; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- documentos/historial_de_cambios
- web/administrar_empresa/carrito_de_compras.html
...
2026-05-13 20:41:44 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: c009e592; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- documentos/historial_de_cambios
- web/administrar_empresa/carrito_de_compras.html
...
2026-05-14 17:30:58 - Mensaje: limpieza preproduccion y reportes unificados; Commit: 06e5eb42; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/nuevos_verticales_bootstrap.go
- backend/db/tipo_empresa_preconfiguracion.go
...
- backend/handlers/graficos_estadisticas.go
- backend/main.go
- backend/scripts/run_integration_postgres.ps1
- backend/scripts/seed_postgres_empresas.sql
- backend/scripts/seed_postgres_super.sql
- backend/tools/pruebas_finanzas_motel_calipso/main.go
- backup/empresas/7/configuracion_empresa_7_20260506_174508_BKP-7-20260506174507-1778107507972028400.json
- backup/empresas/7/configuracion_empresa_7_20260506_181114_BKP-7-20260506181113-1778109073518863800.json
- backup/empresas/7/configuracion_empresa_7_20260506_193316_BKP-7-20260506193316-1778113996085767200.json
- backup/empresas/7/configuracion_empresa_7_20260506_202100_BKP-7-20260506202059-1778116859669395800.json
...
2026-05-14 17:53:29 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: b3e34513; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/handlers/configuracion_guiada.go
- backend/handlers/empresa_preconfiguracion.go
...
2026-05-15 19:48:41 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: de83b84d; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/asistencia_empleados.go
- backend/db/asistencia_empleados_postgres_test.go
- backend/db/compras_avanzadas.go
...
2026-05-18 16:55:05 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: f436b580; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/handlers/corte_caja.go
- backend/handlers/corte_caja_test.go
- documentos/CHANGELOG.md
- documentos/descripcion_de_archivos
- documentos/descripcion_de_modulos
- documentos/descripcion_del_proyecto
...
2026-05-18 18:17:42 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: a80f4ffb; PushStatus: OK
Archivos modificados:
- backend/db/compras_avanzadas.go
- backend/db/empresa_estacion_aseo.go
- backend/db/finanzas.go
...
- web/js/administrar_empresa.js
- web/js/seleccionar_empresa.js
- web/js/tarifas_de_hotel.js
- web/js/tarifas_de_motel.js
- web/super/licencias.html
- web/super/preconfiguracion_tipos_empresa.html

2026-05-18 22:11:06 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 6e613b94; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/corte_caja_configuracion.go
- backend/db/corte_caja_configuracion_test.go
- backend/handlers/corte_caja.go
- documentos/CHANGELOG.md
- documentos/descripcion_de_archivos
- documentos/descripcion_de_modulos
...
2026-05-18 22:47:28 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 81acf7b4; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- documentos/CHANGELOG.md
- documentos/descripcion_de_archivos
...
2026-05-19 00:00:17 - Mensaje: POS 80mm para reporte de turno; Commit: b63f3e9f; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/corte_caja_configuracion.go
...
2026-05-19 00:31:37 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 0344b089; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/empresa_configuracion_general.go
- backend/handlers/carritos_compras.go
...
2026-05-19 15:43:23 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 7781a537; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/codigos_descuento.go
- backend/db/facturacion_electronica.go
...
- backend/handlers/facturacion_electronica.go
- backend/handlers/payments_handlers.go
- backend/handlers/super_docker_portabilidad.go
- backend/handlers/super_docker_portabilidad_test.go
- backend/main.go
- backend/main_empresa_routes_security_test.go
...
- web/administrar_empresa/configuracion_de_estaciones.html
- web/administrar_empresa/corte_de_caja.html
- web/administrar_empresa/facturacion_electronica_ecuador.html
- web/administrar_empresa/facturacion_electronica_menu.html
- web/administrar_empresa/facturacion_electronica_panama.html
- web/administrar_empresa/panel.html
- web/administrar_empresa/reportes_turnos.html
- web/estilos.css
- web/js/administrar_empresa.js
...
2026-05-20 17:50:20 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 2857a62b; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/nomina_colombia_avanzada.go
- backend/db/nomina_colombia_avanzada_test.go
...
2026-05-21 19:27:33 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 89229a02; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/carritos_compras.go
- backend/db/empresa_impresoras.go
...
- backend/handlers/carritos_compras.go
- backend/handlers/chat_flotante_config.go
- backend/handlers/chat_flotante_config_test.go
- backend/handlers/corte_caja.go
- backend/handlers/empresa_impresoras.go
- backend/handlers/empresa_permisos.go
- backend/handlers/pagina_principal_handlers.go
- backend/handlers/payments_handlers.go
- backend/handlers/recetas_productos.go
- backend/handlers/reportes.go
- backend/main.go
- documentos/CHANGELOG.md
- documentos/api/openapi.generated.yaml
...
- documentos/descripcion_del_proyecto
- documentos/diagramas/estructura_del_codigo.md
- documentos/erp_multiempresa/03_especificaciones_funcionales_erp_multiempresa.md
- documentos/estructura_bd.md
- documentos/historial_de_cambios
- documentos/matriz_roles_permisos_pos_multiempresa.md
- tmp_recetas_calipso_edicion.png
- tmp_recetas_calipso_ingredientes.png
- tmp_recetas_calipso_visual.png
- web/administrar_empresa.html
- web/administrar_empresa/administrar_productos_menu.html
- web/administrar_empresa/auditoria.html
- web/administrar_empresa/carrito_de_compras.html
...
2026-05-21 19:48:07 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: fa386b65; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/contextual_help_test.go
- backend/main.go
...
2026-05-25 15:58:45 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: c4e25f81; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/creditos.go
- backend/db/creditos_postgres_test.go
...
2026-05-25 19:23:43 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 20099c05; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- documentos/CHANGELOG.md
- documentos/descripcion_de_modulos
...
2026-05-25 20:04:03 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 4e9e8cc3; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/handlers/empresa_permisos.go
- documentos/CHANGELOG.md
...
2026-05-27 13:14:03 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: ca6dbd74; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/handlers/empresa_preconfiguracion.go
- backend/handlers/empresa_preconfiguracion_carrito_test.go
...
- web/administrar_empresa/configuracion_de_estaciones.html
- web/estilos.css
- web/img/Titulo powerful control system.png
- web/img/titulo-powerful-control-system-login.png
- web/index.html
- web/login.html

2026-05-27 15:41:17 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 5da4dc0a; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
...
- documentos/matriz_roles_permisos_pos_multiempresa.md
- web/estilos.css
- web/img/world-map-natural-earth-public-domain.svg
- web/index.html
- web/js/portal_visits.js
- web/js/super_administrador.js
...
2026-05-27 20:41:32 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 1657b97b; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/db.go
- backend/handlers/auth_admin_handlers.go
...
2026-05-28 01:15:02 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 7fcc4441; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/auditoria_super.go
- backend/db/energia_solar.go
- backend/handlers/auditoria_super.go
- backend/handlers/empresa_permisos.go
...
- web/js/seleccionar_empresa.js
- web/js/super_administrador.js
- web/js/super_auditoria_global.js
- web/menu.js
- web/seleccionar_empresa.html
- web/super/auditoria_global.html
- web/super/auditoria_super_admin.html
- web/super/configuracion_avanzada.html
- web/super/voz_streaming_ia.html
- web/super_administrador.html
...
2026-05-28 03:34:37 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 1f3eb633; PushStatus: OK
Archivos modificados:
- backend/db/empresa_estacion_prefs.go
- backend/handlers/chat_flotante_config.go
- backend/main.go
...
2026-05-28 13:46:17 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 44529a5a; PushStatus: OK
Archivos modificados:
- backend/db/email_corporativo.go
- backend/db/usuario_config_schema.go
- backend/handlers/email_corporativo_handlers.go
- backend/handlers/system_empresas_handlers.go
- backend/main.go
- backend/tools/register_iredmail_secrets/main.go
- deploy/.env.platform.example
- deploy/README-compose-platform.md
- deploy/docker-compose.platform.yml
- deploy/iredmail/.env.example
- deploy/iredmail/README.md
- deploy/iredmail/docker-compose.iredmail.yml
- deploy/nginx/edge-http-only.conf.template
- deploy/nginx/edge.conf.template
- deploy/scripts/vps-docker-preflight.sh
...
2026-05-28 18:29:18 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 83b7ab3b; PushStatus: OK
Archivos modificados:
- .gitignore
- tmp_email_panel_after_fix.png
- tmp_email_panel_logged.png
...
2026-05-28 18:49:22 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 6d9c73dd; PushStatus: OK
Archivos modificados:
- backend/handlers/email_corporativo_handlers.go
- web/super/email_corporativo.html
...
2026-05-28 19:39:07 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 532b6a0c; PushStatus: OK
Archivos modificados:
- backend/handlers/email_corporativo_handlers.go
- deploy/.env.platform.example
- deploy/docker-compose.platform.yml
...
2026-05-29 13:50:16 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 2164fac8; PushStatus: OK
Archivos modificados:
- .gitignore
- backend/db/control_electrico.go
- backend/db/email_corporativo.go
...
- backend/handlers/payments_handlers.go
- backend/handlers/payments_handlers_test.go
- backend/handlers/super_domotica_storage.go
- backend/handlers/usuarios_empresa.go
- backend/main.go
- backend/tools/register_iredmail_secrets/main.go
- backend/tools/seed_domotica_motel_calipso/main.go
- backend/utils/utils.go
- deploy/.env.platform.example
- deploy/README-compose-platform.md
- deploy/docker-compose.platform.yml
...
- deploy/iredmail/README.md
- deploy/iredmail/docker-compose.iredmail.yml
- deploy/mailu/snappymail-application.ini
- deploy/nginx/edge-http-only.conf.template
- deploy/nginx/edge.conf.template
- deploy/scripts/vps-compose-sidecar-up.sh
...
- documentos/matriz_roles_permisos_pos_multiempresa.md
- scripts/sync_to_vps.ps1
- tmp/static-web-18741.err
- tmp/static-web-18741.out
- tmp/static-web-8099.err
- tmp/static-web-8099.out
- web/administrar_empresa.html
- web/administrar_empresa/administrar_usuarios.html
- web/administrar_empresa/auditoria.html
- web/administrar_empresa/carrito_control_electrico.html
...
- web/js/seleccionar_empresa.js
- web/menu.js
- web/super/domotica_storage.html
- web/super/email_corporativo.html
- web/super/licencias.html
- web/super_administrador.html
...
2026-05-29 21:53:57 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 0b6e2b04; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- RESUMEN_DEL_PROYECTO.md
- backend/db/db.go
- backend/db/email_corporativo.go
- backend/db/empresas_idempotencia_test.go
- backend/db/facturacion_electronica.go
- backend/db/modulos_empresariales_colombia.go
- backend/db/modulos_plantillas_nuevas.go
- backend/db/modulos_plantillas_nuevas_test.go
...
- backend/handlers/empresa_permisos.go
- backend/handlers/empresa_permisos_licencias_test.go
- backend/handlers/empresa_plantillas_integracion.go
- backend/handlers/empresa_plantillas_integracion_test.go
- backend/handlers/empresa_plantillas_nuevas.go
- backend/handlers/empresa_plantillas_nuevas_test.go
- backend/handlers/empresa_preconfiguracion.go
- backend/handlers/empresa_preconfiguracion_carrito_test.go
- backend/handlers/pagina_principal_handlers.go
- backend/handlers/super_portal_chat_ia_info.go
...
- deploy/docker-compose.platform.yml
- deploy/mailu/snappymail-application.ini
- deploy/mailu/themes/PCSDark/styles.css
- deploy/mailu/themes/PCSLight/styles.css
- deploy/scripts/vps-compose-sidecar-up.sh
- deploy/scripts/vps-provision-mailu-mailbox.sh
- documentos/CHANGELOG.md
- documentos/README.md
...
- documentos/historial_de_cambios
- documentos/mapa_modulos.md
- documentos/matriz_integracion_plantillas.md
- documentos/matriz_roles_permisos_pos_multiempresa.md
- documentos/plan_20_modulos_plantillas_2026-05-10.md
- documentos/plan_modulos_faltantes_colombia_2026-05-06.md
- documentos/plan_plantillas_produccion_masiva_2026-05-11.md
- documentos/plan_profesionalizacion_plataforma.md
- documentos/plan_qa_e2e_motel_calipso_2026-05-06.md
- documentos/reporte_estado_modulos_2026-05-02.md
- documentos/reporte_estado_modulos_2026-05-03.md
...
- web/administrar_empresa.html
- web/administrar_empresa/carrito_de_compras.html
- web/administrar_empresa/configuracion/email_corporativo.html
- web/administrar_empresa/configuracion_carrito_de_compra_empresa.html
- web/administrar_empresa/configuracion_de_estaciones.html
- web/administrar_empresa/configuracion_menu.html
- web/administrar_empresa/configuracion_permisos.html
...
- web/administrar_empresa/modulo_menu.html
- web/administrar_empresa/panel.html
- web/administrar_empresa/plantillas_integracion.html
- web/administrar_empresa/plantillas_nuevas_menu.html
- web/ayuda/ayuda.html
- web/descripcion_de_los_sistemas.ht
- web/descripcion_de_los_sistemas.html
- web/elegir_licencia.html
...
- web/js/button_icons.js
- web/js/modulo_colombia_admin.js
- web/js/plantillas_integracion_catalogo.js
...
2026-05-30 13:40:12 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 5bd7e933; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- documentos/CHANGELOG.md
- documentos/README.md
...
2026-05-30 15:26:06 - Mensaje: ajustar terminos wompi licencias; Commit: c3ac001c; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/handlers/payments_handlers.go
- documentos/CHANGELOG.md
- documentos/historial_de_cambios
- tmp/licencias-visual/05-super-licencias-actualizado.png
- tmp/licencias-visual/06-agregar-empresa-modal.png
- tmp/licencias-visual/07-empresa-creada.png
- tmp/licencias-visual/08-licencias-disponibles.png
- tmp/licencias-visual/09-checkout-prueba.png
- tmp/licencias-visual/10-prueba-activada.png
- tmp/licencias-visual/11-despues-prueba-solo-comerciales.png
- tmp/licencias-visual/12-checkout-plan-comercial.png

2026-05-30 15:37:14 - Mensaje: corregir configuracion general postgres; Commit: 8ec78a28; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/empresa_configuracion_general.go
- documentos/CHANGELOG.md
- documentos/historial_de_cambios
- tmp/licencias-visual/13-basico-checkout-antes-descuento.png
- tmp/licencias-visual/16-basico-activada.png
- tmp/licencias-visual/16-basico-checkout-antes-descuento.png
- tmp/licencias-visual/16-basico-checkout-total-cero.png
- tmp/licencias-visual/17-profesional-activada.png
- tmp/licencias-visual/17-profesional-checkout-antes-descuento.png
- tmp/licencias-visual/17-profesional-checkout-total-cero.png
- tmp/licencias-visual/18-empresarial-activada.png
- tmp/licencias-visual/18-empresarial-checkout-antes-descuento.png
- tmp/licencias-visual/18-empresarial-checkout-total-cero.png

2026-05-30 15:44:46 - Mensaje: reforzar configuracion general postgres; Commit: 446efb57; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/empresa_configuracion_general.go
- backend/db/sql_compat.go
...
2026-05-31 02:56:52 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 8d7b64ce; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/utils/utils.go
- documentos/CHANGELOG.md
...
2026-05-31 16:27:07 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 56101d0c; PushStatus: OK
Archivos modificados:
- documentos/CHANGELOG.md
- documentos/contexto_codex.md
- documentos/flujos_operativos.md
...
2026-05-31 22:34:11 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: f9dea1cf; PushStatus: OK
Archivos modificados:
- backend/db/db.go
- backend/db/email_corporativo.go
- backend/db/licencias_renovacion_test.go
- backend/db/tipo_empresa_preconfiguracion.go
- backend/db/tipo_empresa_preconfiguracion_test.go
- backend/handlers/carritos_compras.go
- backend/handlers/email_corporativo_handlers.go
...
- backend/handlers/empresa_estacion_aseo.go
- backend/handlers/empresa_permisos.go
- backend/handlers/licencias_pdf.go
- backend/handlers/licencias_pdf_test.go
- backend/handlers/offline_ventas.go
- backend/handlers/offline_ventas_test.go
- backend/handlers/pagina_principal_handlers.go
- backend/handlers/payments_handlers.go
- backend/handlers/payments_handlers_test.go
- backend/handlers/portero_permissions_test.go
- backend/handlers/super_email_templates.go
- backend/main.go
- backend/main_empresa_delete_frontend_contract_test.go
- backend/utils/auth_middleware_test.go
...
- documentos/mapa_modulos.md
- documentos/matriz_roles_permisos_pos_multiempresa.md
- tmp/checkout-licencias-epayco-wompi.png
- web/administrar_empresa.html
- web/administrar_empresa/carrito_de_compras.html
- web/administrar_empresa/estaciones.html
- web/administrar_empresa/finanzas_menu.html
...
2026-06-01 11:40:43 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 7d4268d3; PushStatus: OK
Archivos modificados:
- backend/db/chat_inteligencia_artificial.go
- backend/db/empresa_admin_compartida.go
- backend/handlers/empresa_compartida_handlers.go
...
- backend/handlers/licencias_codigos_descuento_test.go
- backend/handlers/payments_handlers.go
- backend/handlers/selector_admin_scope_test.go
- backend/main.go
- documentos/CHANGELOG.md
...
2026-06-01 21:14:25 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 481d9b72; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/grafologia.go
- backend/db/roles_tipos_usuario.go
- backend/db/roles_tipos_usuario_test.go
- backend/handlers/chat_con_inteligencia_artificial_controller.go
- backend/handlers/grafologia.go
- backend/handlers/usuarios_empresa.go
- backend/internal/grafologia/analyzer.go
...
- documentos/mapa_modulos.md
- documentos/matriz_roles_permisos_pos_multiempresa.md
- tmp/grafologia_gpt55_prod_after_fix.png
- tmp/grafologia_gpt55_prod_final.png
- tmp/grafologia_gpt55_prod_final_clear.png
- tmp/grafologia_gpt55_prod_result.png
- tmp/grafologia_louise_pomeroy_letter_1886.jpg
- tmp/grafologia_zoom_fill_card.png
- web/administrar_empresa/administrar_usuarios.html
- web/administrar_empresa/grafologia.html
- web/ayuda/ayuda.html
- web/js/grafologia.js
...
2026-06-02 02:12:07 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 3a945016; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/roles_tipos_usuario.go
- backend/db/roles_tipos_usuario_test.go
...
2026-06-02 02:32:09 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: eb86dce2; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/usuarios_empresa.go
...
2026-06-02 12:20:30 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 915a7a56; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- documentos/historial_de_cambios
- web/ayuda/ayuda.html
...
2026-06-02 12:57:31 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 23790797; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- documentos/historial_de_cambios
- tmp/visual-cajero-alfaix/01-panel-cajero.png
- tmp/visual-cajero-alfaix/02-estaciones-cajero.png
- tmp/visual-cajero-alfaix/03-despues-click-estacion.png
- tmp/visual-cajero-alfaix/04-carrito-cajero.png
- tmp/visual-cajero-alfaix/resultado.txt
- web/administrar_empresa/carrito_de_compras.html

2026-06-02 13:03:15 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 89b97488; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- documentos/historial_de_cambios
- tmp/visual-cajero-alfaix-activo/carrito-activo.png
- tmp/visual-cajero-alfaix-activo/resultado.txt
- tmp/visual-cajero-alfaix-final/01-panel-cajero.png
- tmp/visual-cajero-alfaix-final/02-estaciones.png
...
2026-06-04 17:15:54 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: fccdb3eb; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
...
- web/administrar_empresa/configuracion.html
- web/seleccionar_empresa.html
- web/super/historial_licencias.html
- web/super/licencias.html

2026-06-04 17:39:23 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 18164970; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/handlers/licencias_pdf.go
- backend/handlers/licencias_pdf_test.go
...
2026-06-05 01:41:18 - Mensaje: Reparar empresa interna Powerful Control System; Commit: 38795757; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/chat_inteligencia_artificial.go
- backend/db/db.go
...
2026-06-05 02:32:56 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 6dc99cfd; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/modulos_faltantes.go
- backend/handlers/control_electrico.go
...
2026-06-05 15:30:14 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 970674c2; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/db.go
- backend/db/empresa_admin_compartida.go
...
- backend/db/modulos_faltantes.go
- backend/db/usuario_config_schema.go
- backend/db/usuario_config_schema_test.go
- backend/handlers/dian_signature_upload_test.go
- backend/handlers/modulos_faltantes.go
- backend/handlers/onlyoffice.go
- backend/handlers/onlyoffice_test.go
...
- backend/handlers/payments_handlers.go
- backend/handlers/payments_handlers_test.go
- backend/handlers/user_config.go
- documentos/CHANGELOG.md
- documentos/contexto_codex.md
- documentos/descripcion_de_archivos
- documentos/descripcion_de_modulos
...
2026-06-06 17:36:30 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 1496a88a; PushStatus: OK
Archivos modificados:
- backend/handlers/modulos_faltantes.go
...
2026-06-06 18:22:39 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: f922aaa4; PushStatus: OK
Archivos modificados:
- backend/handlers/dian_signature_upload_test.go
- backend/handlers/modulos_faltantes.go
- documentos/CHANGELOG.md
...
2026-06-06 19:09:09 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: de92b6f6; PushStatus: OK
Archivos modificados:
- backend/handlers/dian_signature_upload_test.go
- backend/handlers/modulos_faltantes.go
- documentos/CHANGELOG.md
...
2026-06-06 19:23:40 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 47b15ec3; PushStatus: OK
Archivos modificados:
- backend/handlers/dian_signature_upload_test.go
- backend/handlers/modulos_faltantes.go
- documentos/CHANGELOG.md
...
2026-06-06 19:45:39 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 56dddf37; PushStatus: OK
Archivos modificados:
- web/administrar_empresa/facturacion_electronica_pruebas_dian.html

2026-06-06 20:04:51 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 5d15fe3a; PushStatus: OK
Archivos modificados:
- documentos/CHANGELOG.md
- documentos/descripcion_de_modulos
- documentos/historial_de_cambios
...
2026-06-06 20:14:24 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: e77a2d31; PushStatus: OK
Archivos modificados:
- documentos/CHANGELOG.md
- documentos/descripcion_de_modulos
- documentos/historial_de_cambios
...
2026-06-06 21:46:15 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 4e961b19; PushStatus: OK
Archivos modificados:
- documentos/CHANGELOG.md
- documentos/descripcion_de_archivos
- documentos/descripcion_de_modulos
...
2026-06-07 03:31:43 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: b8d0ca6d; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/handlers/empresa_ia_empresarial.go
- backend/handlers/empresa_permisos.go
- backend/handlers/empresa_permisos_test.go
- backend/handlers/facturacion_electronica.go
- backend/handlers/portero_permissions_test.go
...
- web/administrar_empresa.html
- web/administrar_empresa/auditoria.html
- web/administrar_empresa/centro_ia_empresarial.html
- web/administrar_empresa/facturacion_electronica.html
- web/administrar_empresa/facturacion_electronica_pruebas_dian.html
- web/administrar_empresa/finanzas_menu.html
- web/administrar_empresa/niif.html
- web/administrar_empresa/renta_ia.html
- web/administrar_empresa/reportes_ejecutivos.html
- web/administrar_empresa/soportes_compras_ia.html
...
2026-06-07 13:11:37 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 563995c6; PushStatus: OK
Archivos modificados:
...
2026-06-07 15:36:56 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: aeb25764; PushStatus: OK
Archivos modificados:
- backend/db/empresa_configuracion_avanzada.go
- documentos/CHANGELOG.md
- documentos/contexto_codex.md
...
2026-06-08 02:25:35 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 942896ff; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- documentos/CHANGELOG.md
- documentos/contexto_codex.md
...
2026-06-08 02:43:27 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 4b1c9f51; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- documentos/CHANGELOG.md
- documentos/contexto_codex.md
...
2026-06-08 03:40:36 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 49d95d73; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/modulos_faltantes.go
- backend/handlers/dian_signature_upload_test.go
...
2026-06-08 06:00:00 - Mensaje: DIAN: consumidor final y firma canonicalizada; Commit: c130bf74; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/handlers/dian_signature_upload_test.go
- backend/handlers/modulos_faltantes.go
...
2026-06-09 03:42:34 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 92f680f6; PushStatus: OK
Archivos modificados:
- .dockerignore
- backend/db/aiu_construccion.go
- backend/db/asistencia_empleados.go
...
- backend/db/comisiones_servicio.go
- backend/db/compras_avanzadas.go
- backend/db/compras_y_proveedores.go
...
- backend/db/empresa_colombia_defaults.go
- backend/db/empresa_configuracion_avanzada.go
- backend/db/empresa_configuracion_avanzada_postgres_test.go
- backend/db/empresa_configuracion_general.go
- backend/db/empresa_estacion_aseo.go
- backend/db/empresa_impresoras.go
- backend/db/empresa_permisos_finos.go
- backend/db/estacion_columnas_pref.go
- backend/db/estacion_vip_codigos.go
- backend/db/eventos_contables.go
- backend/db/facturacion_electronica.go
- backend/db/finanzas.go
- backend/db/finanzas_conciliacion_bancaria.go
...
- backend/db/super_alertas.go
- backend/db/super_correos_masivos.go
- backend/db/super_errores_sistema.go
- backend/db/super_juegos.go
- backend/db/super_servidor_eventos.go
- backend/db/tarifas_motel.go
...
- web/administrar_empresa/carrito_de_compras.html
- web/administrar_empresa/configuracion.html
- web/administrar_empresa/configuracion/perfil_tributario_colombia.html
- web/administrar_empresa/configuracion_menu.html
- web/administrar_empresa/facturas_electronicas.html

2026-06-09 07:04:38 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 6578f939; PushStatus: OK
Archivos modificados:
- backend/db/empresa_impresoras.go
- backend/db/empresa_impresoras_cola_test.go
- backend/db/facturacion_electronica.go
- backend/db/facturacion_electronica_paises_test.go
- backend/handlers/empresa_impresoras.go
- backend/handlers/empresa_impresoras_agente_test.go
- backend/handlers/empresa_permisos.go
- backend/main.go
- backend/tmp/prueba_impresoras_pcs.png
- backend/tmp_printer_server.pid
- documentos/CHANGELOG.md
- documentos/api/openapi.generated.yaml
- documentos/descripcion_de_archivos
- documentos/descripcion_de_modulos
...
2026-06-09 20:20:09 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 2ee380e9; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/alquileres_bootstrap.go
- backend/db/alquileres_bootstrap_test.go
...
- backend/db/licencias_globales.go
- backend/db/licencias_globales_test.go
- backend/db/licencias_retencion_empresas.go
- backend/db/licencias_retencion_empresas_test.go
- backend/db/plantillas_nuevas_bootstrap.go
- backend/db/plantillas_nuevas_bootstrap_test.go
...
- backend/handlers/empresa_upload_paths.go
- backend/handlers/facturacion_electronica.go
- backend/handlers/licencias_advance_limit_test.go
- backend/handlers/licencias_pdf_test.go
- backend/handlers/licencias_vencimiento_alertas.go
- backend/handlers/modulos_faltantes.go
- backend/handlers/payments_handlers.go
...
- backend/handlers/super_vps_snapshots_test.go
- backend/handlers/usuarios_empresa.go
- backend/handlers/venta_publica.go
- backend/main.go
- documentos/CHANGELOG.md
...
- web/administrar_empresa/facturas_electronicas.html
- web/administrar_empresa/nomina_sueldos.html
- web/administrar_empresa/nomina_tutorial.html
- web/administrar_empresa/panel.html
- web/administrar_empresa/ventas.html
- web/ayuda/ayuda.html
- web/estilos.css
- web/img/portal-systems/activos-fijos-niif-fiscal.svg
- web/img/portal-systems/agencia-viajes.svg
- web/img/portal-systems/aiu-construccion.svg
- web/img/portal-systems/alquileres-activos.svg
- web/img/portal-systems/apartamentos-turisticos.svg
- web/img/portal-systems/bancos-pagos-masivos.svg
- web/img/portal-systems/capacitacion-empresarial.svg
- web/img/portal-systems/carnets-empresariales.svg
- web/img/portal-systems/centros-costo.svg
- web/img/portal-systems/certificados-tributarios.svg
- web/img/portal-systems/cierre-fiscal.svg
- web/img/portal-systems/clinica-consultorios.svg
- web/img/portal-systems/club-deportivo.svg
- web/img/portal-systems/cobranza-profesional.svg
- web/img/portal-systems/colegio-academia.svg
- web/img/portal-systems/compras-ocr-ia.svg
- web/img/portal-systems/consultorios-odontologicos.svg
- web/img/portal-systems/cooperativa-fondo.svg
- web/img/portal-systems/domicilios-entregas.svg
- web/img/portal-systems/drogueria-farmacia.svg
- web/img/portal-systems/eventos-boleteria.svg
- web/img/portal-systems/facturacion-electronica-colombia.svg
- web/img/portal-systems/funeraria-exequial.svg
- web/img/portal-systems/gestion-documental-contratos.svg
- web/img/portal-systems/guarderia-infantil.svg
- web/img/portal-systems/inmobiliaria-comercial.svg
- web/img/portal-systems/laboratorio-clinico.svg
- web/img/portal-systems/lavanderia-tintoreria.svg
- web/img/portal-systems/logistica-wms.svg
- web/img/portal-systems/operador-turistico.svg
- web/img/portal-systems/parque-recreativo.svg
- web/img/portal-systems/parqueaderos-ticket-qr.svg
- web/img/portal-systems/produccion-mrp.svg
- web/img/portal-systems/propiedad-horizontal.svg
- web/img/portal-systems/salon-spa.svg
- web/img/portal-systems/seguridad-privada.svg
- web/img/portal-systems/servicios-tecnicos.svg
- web/img/portal-systems/sistema-gimnasios.svg
- web/img/portal-systems/suite-contador.svg
- web/img/portal-systems/taller-mecanico.svg
- web/img/portal-systems/taxi-system.svg
- web/img/portal-systems/tesoreria-presupuesto.svg
- web/img/portal-systems/tickets-ayuda-calidad.svg
- web/img/portal-systems/transporte-carga-tms.svg
- web/img/portal-systems/turnos-atencion.svg
- web/img/portal-systems/veterinaria-petshop.svg
- web/index.html
- web/js/ai_chat_drawer.js
- web/js/plantillas_nuevas_catalogo.js
- web/js/print_documents.js
...
2026-06-09 22:39:18 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: aaa2eca7; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/handlers/email_corporativo_handlers.go
- backend/handlers/email_corporativo_handlers_test.go
...
- documentos/mapa_modulos.md
- documentos/matriz_roles_permisos_pos_multiempresa.md
- scripts/generate_pcs_logo_concepts.mjs
- scripts/generate_portal_realistic_images.ps1
- web/administrar_empresa.html
- web/administrar_empresa/carrito_de_compras.html
- web/administrar_empresa/email_corporativo.html
- web/administrar_empresa/panel.html
- web/estilos.css
- web/img/brand/pcs-logo-concepts/pcs-icon-v1-control-core.png
- web/img/brand/pcs-logo-concepts/pcs-icon-v1-control-core.svg
- web/img/brand/pcs-logo-concepts/pcs-icon-v2-nexus-shield.png
- web/img/brand/pcs-logo-concepts/pcs-icon-v2-nexus-shield.svg
- web/img/brand/pcs-logo-concepts/pcs-icon-v3-pulse-circuit.png
- web/img/brand/pcs-logo-concepts/pcs-icon-v3-pulse-circuit.svg
- web/img/brand/pcs-logo-concepts/pcs-icon-v4-enterprise-stack.png
- web/img/brand/pcs-logo-concepts/pcs-icon-v4-enterprise-stack.svg
- web/img/brand/pcs-logo-concepts/pcs-logo-concepts-contact-sheet.png
- web/img/brand/pcs-logo-concepts/pcs-wordmark-v1-control-core.png
- web/img/brand/pcs-logo-concepts/pcs-wordmark-v1-control-core.svg
- web/img/brand/pcs-logo-concepts/pcs-wordmark-v2-stacked-premium.png
- web/img/brand/pcs-logo-concepts/pcs-wordmark-v2-stacked-premium.svg
- web/img/brand/pcs-logo-concepts/pcs-wordmark-v3-dark-enterprise.png
- web/img/brand/pcs-logo-concepts/pcs-wordmark-v3-dark-enterprise.svg
- web/img/brand/pcs-logo-concepts/pcs-wordmark-v4-clean-pos.png
- web/img/brand/pcs-logo-concepts/pcs-wordmark-v4-clean-pos.svg
- web/img/brand/pcs-logo-concepts/preview.html
- web/img/portal-systems/realistic/activos-fijos-niif-fiscal.jpg
- web/img/portal-systems/realistic/agencia-viajes.jpg
- web/img/portal-systems/realistic/aiu-construccion.jpg
- web/img/portal-systems/realistic/alquileres-activos.jpg
- web/img/portal-systems/realistic/apartamentos-turisticos.jpg
- web/img/portal-systems/realistic/bancos-pagos-masivos.jpg
- web/img/portal-systems/realistic/capacitacion-empresarial.jpg
- web/img/portal-systems/realistic/carnets-empresariales.jpg
- web/img/portal-systems/realistic/centros-costo.jpg
- web/img/portal-systems/realistic/certificados-tributarios.jpg
- web/img/portal-systems/realistic/cierre-fiscal.jpg
- web/img/portal-systems/realistic/clientes-crm.jpg
- web/img/portal-systems/realistic/clinica-consultorios.jpg
- web/img/portal-systems/realistic/club-deportivo.jpg
- web/img/portal-systems/realistic/cobranza-profesional.jpg
- web/img/portal-systems/realistic/compras-ocr-ia.jpg
- web/img/portal-systems/realistic/consultorios-odontologicos.jpg
- web/img/portal-systems/realistic/control-sensor.jpg
- web/img/portal-systems/realistic/cooperativa-fondo.jpg
- web/img/portal-systems/realistic/domicilios-entregas.jpg
- web/img/portal-systems/realistic/drogueria-farmacia.jpg
- web/img/portal-systems/realistic/eventos-boleteria.jpg
- web/img/portal-systems/realistic/facturacion-electronica-colombia.jpg
- web/img/portal-systems/realistic/funeraria-exequial.jpg
- web/img/portal-systems/realistic/gestion-documental-contratos.jpg
- web/img/portal-systems/realistic/guarderia-infantil.jpg
- web/img/portal-systems/realistic/hotel.jpg
- web/img/portal-systems/realistic/inmobiliaria-comercial.jpg
- web/img/portal-systems/realistic/laboratorio-clinico.jpg
- web/img/portal-systems/realistic/lavanderia-tintoreria.jpg
- web/img/portal-systems/realistic/logistica-wms.jpg
- web/img/portal-systems/realistic/motel.jpg
- web/img/portal-systems/realistic/operador-turistico.jpg
- web/img/portal-systems/realistic/parque-recreativo.jpg
- web/img/portal-systems/realistic/parqueaderos-ticket-qr.jpg
- web/img/portal-systems/realistic/produccion-mrp.jpg
- web/img/portal-systems/realistic/propiedad-horizontal.jpg
- web/img/portal-systems/realistic/punto-venta.jpg
- web/img/portal-systems/realistic/restaurante.jpg
- web/img/portal-systems/realistic/salon-spa.jpg
- web/img/portal-systems/realistic/seguridad-privada.jpg
- web/img/portal-systems/realistic/servicios-tecnicos.jpg
- web/img/portal-systems/realistic/sistema-gimnasios.jpg
- web/img/portal-systems/realistic/suite-contador.jpg
- web/img/portal-systems/realistic/taller-mecanico.jpg
- web/img/portal-systems/realistic/taxi-system.jpg
- web/img/portal-systems/realistic/tesoreria-presupuesto.jpg
- web/img/portal-systems/realistic/tickets-ayuda-calidad.jpg
- web/img/portal-systems/realistic/transporte-carga-tms.jpg
- web/img/portal-systems/realistic/turnos-atencion.jpg
- web/img/portal-systems/realistic/veterinaria-petshop.jpg
- web/index.html
- web/js/administrar_empresa.js
- web/js/plantillas_nuevas_catalogo.js
- web/login.html
...
2026-06-10 02:08:46 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 14896813; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/asesor_comercial.go
- backend/db/empresa_estacion_prefs.go
- backend/handlers/asesor_comercial.go
- backend/handlers/asesor_comercial_commission_test.go
- backend/handlers/chat_con_inteligencia_artificial_controller.go
- backend/handlers/chat_con_inteligencia_artificial_router.go
- backend/handlers/chat_flotante_config.go
- backend/handlers/chat_flotante_config_test.go
...
- backend/handlers/empresa_preconfiguracion.go
- backend/handlers/empresa_preconfiguracion_carrito_test.go
- backend/handlers/ia_radio.go
- backend/handlers/payments_handlers.go
- backend/handlers/usuarios_empresa_invitation_test.go
- backend/main.go
- backend/main_env_test.go
- documentos/CHANGELOG.md
- documentos/contexto_codex.md
- documentos/descripcion_de_archivos
- documentos/descripcion_de_modulos
...
2026-06-10 09:29:03 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 9a0ec4c2; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- documentos/CHANGELOG.md
- documentos/descripcion_de_archivos
...
2026-06-10 10:29:25 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: ab8a333c; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- documentos/CHANGELOG.md
- documentos/descripcion_de_archivos
...
2026-06-10 10:50:55 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 5af4d5e9; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- documentos/CHANGELOG.md
- documentos/descripcion_de_archivos
...
2026-06-10 10:57:55 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 274a5da1; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- documentos/historial_de_cambios
- web/administrar_empresa/carrito_de_compras.html

2026-06-10 12:19:12 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: d6c7e581; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- documentos/CHANGELOG.md
- documentos/descripcion_de_archivos
...
2026-06-10 18:53:16 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 99699903; PushStatus: OK
Archivos modificados:
- web/administrar_empresa/carrito_de_compras.html

2026-06-10 23:31:04 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: af4273a1; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/auditoria_empresa.go
- backend/db/db.go
...
- backend/db/tipo_empresa_preconfiguracion.go
- backend/db/tipo_empresa_preconfiguracion_test.go
- backend/handlers/auditoria_modulos_especificos.go
...
- backend/handlers/empresa_preconfiguracion.go
- backend/handlers/empresa_preconfiguracion_carrito_test.go
- backend/handlers/finanzas_breb_qr.go
- backend/handlers/portero_permissions_test.go
- backend/handlers/productos.go
- backend/handlers/productos_import_export_test.go
- backend/handlers/reportes.go
- backend/main.go
- documentos/CHANGELOG.md
- documentos/api/openapi.generated.yaml
...
- web/administrar_empresa/auditoria.html
- web/administrar_empresa/carrito_de_compras.html
- web/administrar_empresa/configuracion/menu_visual.html
- web/administrar_empresa/configuracion_carrito_de_compra_empresa.html
- web/administrar_empresa/configuracion_menu.html
- web/administrar_empresa/finanzas_breb_qr.html
...
2026-06-11 15:51:07 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 70448ed0; PushStatus: OK
Archivos modificados:
- .gitignore
- CHANGELOG.md
- backend/db/configuracion_operativa.go
...
- backend/db/finanzas.go
- backend/db/productos.go
- backend/handlers/configuracion_operativa.go
- backend/handlers/empresa_impresoras.go
- backend/handlers/empresa_impresoras_agente_test.go
- backend/handlers/empresa_permisos.go
- backend/handlers/empresa_permisos_test.go
...
2026-06-13 12:19:49 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 026a12fc; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- documentos/historial_de_cambios
- web/administrar_empresa/carrito_de_compras.html
...
2026-06-13 12:41:09 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 19079df7; PushStatus: OK
Archivos modificados:
- web/administrar_empresa/carrito_de_compras.html

2026-06-13 12:52:33 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: f97b63ca; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- documentos/historial_de_cambios
- web/administrar_empresa/carrito_de_compras.html

2026-06-13 12:58:09 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 55214778; PushStatus: OK
Archivos modificados:
- web/administrar_empresa/carrito_de_compras.html

2026-06-13 13:02:12 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: f1c1bbca; PushStatus: OK
Archivos modificados:
- web/administrar_empresa/carrito_de_compras.html

2026-06-13 13:07:25 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 5b647b6e; PushStatus: OK
Archivos modificados:
- web/administrar_empresa/carrito_de_compras.html

2026-06-13 13:17:56 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 8c4e76eb; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/usuarios_empresa.go
- backend/handlers/empresa_permisos.go
...
2026-06-13 19:47:07 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: bb1961d0; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- documentos/historial_de_cambios
- web/administrar_empresa/carrito_de_compras.html
...
2026-06-13 19:54:05 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: f01da14b; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- documentos/historial_de_cambios
- web/js/button_icons.js
...
2026-06-13 20:04:05 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 35d9f75a; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- documentos/historial_de_cambios
- web/administrar_empresa/creditos_menu.html
...
2026-06-13 20:38:47 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: c4bb0d72; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- documentos/contexto_codex.md
- web/estilos.css
...
2026-06-13 22:31:27 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: ebdc2c61; PushStatus: OK
Archivos modificados:
- web/administrar_empresa/carrito_de_compras.html

2026-06-13 22:40:48 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: cb571547; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/productos.go
- documentos/historial_de_cambios
...
2026-06-14 10:57:36 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: f49fe1b6; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- documentos/historial_de_cambios
- web/administrar_empresa.html
...
2026-06-15 20:38:39 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 73c12cb7; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/handlers/carritos_compras.go
- documentos/descripcion_de_archivos
...
2026-06-16 12:24:56 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 48df7367; PushStatus: OK
Archivos modificados:
- backend/db/facturacion_electronica.go
- backend/handlers/modulos_faltantes.go

2026-06-16 12:30:16 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 66786f81; PushStatus: OK
Archivos modificados:
- backend/handlers/modulos_faltantes.go

2026-06-16 14:16:54 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: f09e0045; PushStatus: OK
Archivos modificados:
- backend/handlers/facturacion_electronica.go
- backend/handlers/modulos_faltantes.go
...
2026-06-17 14:37:28 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 73bebafb; PushStatus: OK
Archivos modificados:
- backend/handlers/dian_numeracion_1876_test.go
- backend/handlers/modulos_faltantes.go

2026-06-17 14:47:31 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 554c6131; PushStatus: OK
Archivos modificados:
- backend/handlers/dian_numeracion_1876_test.go
- backend/handlers/modulos_faltantes.go

2026-06-17 14:57:28 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 5be11ef7; PushStatus: OK
Archivos modificados:
- backend/handlers/dian_numeracion_1876_test.go
- backend/handlers/modulos_faltantes.go

2026-06-17 15:07:18 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 36cf8e1e; PushStatus: OK
Archivos modificados:
- backend/handlers/dian_numeracion_1876_test.go
- backend/handlers/modulos_faltantes.go

2026-06-17 15:19:58 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 14f39387; PushStatus: OK
Archivos modificados:
- backend/handlers/dian_numeracion_1876_test.go
- documentos/comandos_codex.md
- documentos/contexto_codex.md
...
2026-06-17 15:32:49 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 14bf6482; PushStatus: OK
Archivos modificados:
- backend/handlers/modulos_faltantes.go

2026-06-17 15:38:34 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: dadbbb22; PushStatus: OK
Archivos modificados:
- backend/handlers/modulos_faltantes.go

2026-06-17 15:43:59 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: b08cdb28; PushStatus: OK
Archivos modificados:
- backend/handlers/modulos_faltantes.go

2026-06-17 15:49:24 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 0c1fd2bb; PushStatus: OK
Archivos modificados:
- backend/handlers/modulos_faltantes.go
...
2026-06-17 16:07:39 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 90dc4855; PushStatus: OK
Archivos modificados:
- backend/handlers/modulos_faltantes.go
- documentos/comandos_codex.md
- documentos/mapa_modulos.md
...
2026-06-17 18:41:02 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 01d096b8; PushStatus: OK
Archivos modificados:
- documentos/historial_de_cambios
- web/administrar_empresa/facturacion_electronica.html
...
2026-06-17 20:23:31 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 90d82958; PushStatus: OK
Archivos modificados:
- backend/handlers/facturacion_electronica.go
...
2026-06-18 17:31:13 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: d7af5c0c; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/chat_inteligencia_artificial.go
- backend/db/db.go
- backend/db/ocr.go
- backend/db/super_errores_sistema.go
- backend/db/super_mantenimiento_agentes.go
- backend/handlers/empresa_permisos.go
- backend/handlers/facturacion_electronica.go
- backend/handlers/grafologia.go
- backend/handlers/ocr.go
...
- backend/handlers/super_mantenimiento_agentes.go
- backend/handlers/super_panel_control_handlers.go
- backend/internal/grafologia/analyzer.go
- backend/main.go
- deploy/docker-compose.platform.yml
- deploy/docker/backend.Dockerfile
...
- web/js/administrar_empresa.js
- web/js/super_administrador.js
- web/super/agentes_de_mantenimiento_qutomatico.html
- web/super/configuracion/ia_global.html
- web/super/configuracion/ocr.html
- web/super/licencias.html
- web/super/licencias_resumen.html
...
2026-06-18 22:41:02 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: e7fa22bd; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/empresa_agentes_uso.go
...
- backend/handlers/super_mantenimiento_agentes.go
- backend/handlers/usuarios_empresa.go
- backend/handlers/venta_digital.go
- backend/main.go
- documentos/api/openapi.generated.yaml
- documentos/descripcion_de_archivos
- documentos/email_corporativo_mailu.md
...
2026-06-19 15:15:03 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: ea24ebd1; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/handlers/email_logo_multipart_test.go
- backend/handlers/licencias_codigos_descuento.go
- backend/handlers/licencias_codigos_descuento_test.go
- backend/handlers/licencias_vencimiento_alertas.go
- backend/handlers/mail_utils.go
...
- backend/handlers/usuarios_empresa.go
- backend/main_empresa_routes_security_test.go
- backend/utils/logs/empresa_12.log
- backend/utils/logs/system_errors.log
- documentos/decisiones_tecnicas.md
- documentos/descripcion_de_archivos
- documentos/descripcion_de_modulos
- documentos/descripcion_del_proyecto
...
2026-06-24 23:38:23 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: f341e78d; PushStatus: OK
Archivos modificados:
- backend/db/carritos_compras.go
- documentos/CHANGELOG.md
- documentos/historial_de_cambios
...
2026-06-25 13:59:50 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 01fbe88c; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- documentos/CHANGELOG.md
- documentos/historial_de_cambios
...
2026-06-25 14:23:32 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 40113053; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- documentos/CHANGELOG.md
- documentos/historial_de_cambios
...
2026-06-25 14:42:49 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 0cbbbb89; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- documentos/CHANGELOG.md
- documentos/historial_de_cambios
...
2026-06-25 15:05:35 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: d7d8fcf0; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/handlers/carritos_compras.go
- documentos/CHANGELOG.md
...
2026-06-25 15:12:16 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 3eaed263; PushStatus: OK
Archivos modificados:
- web/estilos.css

2026-06-25 15:17:08 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 25eb9d50; PushStatus: OK
Archivos modificados:
- web/administrar_empresa/carrito_de_compras.html

2026-06-25 18:15:42 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 168e5432; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- documentos/historial_de_cambios
- web/administrar_empresa/carrito_de_compras.html
...
2026-06-25 18:21:24 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: c53d9e4c; PushStatus: OK
Archivos modificados:
- web/administrar_empresa/carrito_de_compras.html

2026-06-25 19:23:08 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: f917bb53; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- documentos/historial_de_cambios
- web/administrar_empresa/carrito_de_compras.html
...
2026-07-05 19:25:41 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: fc38e2ca; PushStatus: OK
Archivos modificados:
- .codex_tmp/vps2_antispam_logs.sh
- .codex_tmp/vps2_base_setup.sh
- .codex_tmp/vps2_check_rspamd_tags.sh
- .codex_tmp/vps2_check_vnc.sh
- .codex_tmp/vps2_clean_start_pcs.sh
- .codex_tmp/vps2_disable_rspamd_jit.sh
- .codex_tmp/vps2_expose_pcs.sh
- .codex_tmp/vps2_final_check.sh
- .codex_tmp/vps2_finish_base.sh
- .codex_tmp/vps2_finish_vnc.sh
- .codex_tmp/vps2_fix_apt_mirror.sh
- .codex_tmp/vps2_fix_fstab.sh
- .codex_tmp/vps2_fix_mailu_override_format.sh
- .codex_tmp/vps2_fix_vnc_configdir.sh
- .codex_tmp/vps2_fix_vnc_pidfile.sh
- .codex_tmp/vps2_inspect_current.sh
- .codex_tmp/vps2_inspect_mail.sh
- .codex_tmp/vps2_install_nextcloud.sh
- .codex_tmp/vps2_install_vnc_xfce.sh
- .codex_tmp/vps2_mail_status.sh
- .codex_tmp/vps2_move_nextcloud_start_pcs.sh
- .codex_tmp/vps2_repair_mail_antispam.sh
- .codex_tmp/vps2_repair_rspamd_override.sh
- .codex_tmp/vps2_resize_mount.sh
- .codex_tmp/vps2_set_pcs_http_bind.sh
- .codex_tmp/vps2_set_static_ip.sh
- .codex_tmp/vps2_start_mail_profile.sh
- .codex_tmp/vps2_start_pcs_no_mail.sh
- .codex_tmp/vps2_status_vnc.sh
- .codex_tmp/vps2_try_rspamd_19.sh
- .codex_tmp/vps2_tune_nextcloud.sh
- CHANGELOG.md
- backend/handlers/auth_admin_handlers.go
- backend/handlers/licencias_vencimiento_alertas.go
- backend/handlers/mail_utils.go
- backend/handlers/payments_handlers.go
- backend/handlers/super_recordatorios_infraestructura.go
...
2026-07-06 17:23:22 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 98799456; PushStatus: OK
Archivos modificados:
- .sync_e741f4f22738.db-shm
- CHANGELOG.md
- documentos/CHANGELOG.md
- documentos/historial_de_cambios
- scripts/sync_to_vps.ps1
...
2026-07-06 18:00:32 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 7fe455ec; PushStatus: OK
Archivos modificados:
- backend/handlers/super_vps2.go
- scripts/sync_to_vps2.ps1
...
2026-07-07 22:21:00 - Mensaje: Rappi: revisar integracion y blindar rs ante temporales Nextcloud; Commit: 44c84be; PushStatus: OK
Archivos modificados:
- .gitignore
- CHANGELOG.md
- backend/db/rappi.go
- backend/handlers/empresa_permisos.go
- backend/handlers/rappi.go
- backend/main.go
- documentos/CHANGELOG.md
- documentos/README.md
- documentos/api/openapi.generated.yaml
...
- documentos/descripcion_de_modulos
- documentos/descripcion_del_proyecto
- documentos/diagramas/diagramas_sistema_pcs.md
- documentos/diagramas/diagramas_sistema_pcs_manifest.json
- documentos/diagramas/estructura_del_codigo.md
- documentos/estructura_bd.md
- documentos/flujos_operativos.md
- documentos/historial_de_cambios
...
- scripts/sync_to_vps.ps1
- web/administrar_empresa.html
- web/administrar_empresa/rappi.html
- web/estilos.css
- web/js/administrar_empresa.js
- web/js/super_administrador.js
- web/js/super_diagramas.js
- web/js/super_diagramas_data.js
- web/js/super_page_tools.js
- web/super/administradores.html
- web/super/administradores_frecuencia_fe.html
- web/super/administrar_base_de_datos.html
- web/super/agentes_de_mantenimiento_qutomatico.html
...
2026-07-08 17:28:15 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 05026a60; PushStatus: OK
Archivos modificados:
- backend/handlers/empresa_permisos.go
- web/administrar_empresa.html
- web/administrar_empresa/configuracion.html
...
- web/administrar_empresa/ventas.html
- web/menu.js
- web/super/diagramas/agentes_automaticos.html
- web/super/diagramas/api_endpoints.html
- web/super/diagramas/arquitectura.html
- web/super/diagramas/auditoria_logs.html
- web/super/diagramas/base_de_datos_erd.html
- web/super/diagramas/despliegue.html
- web/super/diagramas/facturacion_dian.html
- web/super/diagramas/integraciones.html
- web/super/diagramas/inventario.html
- web/super/diagramas/modulos.html
- web/super/diagramas/multiempresa.html
- web/super/diagramas/reportes.html
- web/super/diagramas/roles_permisos.html
...
2026-07-09 16:52:39 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 04a737e8; PushStatus: OK
Archivos modificados:
- .dockerignore
...
- AGENTS.md
- CHANGELOG.md
- backend/db/entertainment_decommission.go
- backend/db/super_juegos.go
- backend/emulador_local.go
- backend/emulador_local_test.go
- backend/handlers/super_juegos.go
- backend/main.go
- backend/main_frontend_static_resources_test.go
- backend/utils/auth_middleware_test.go
- backend/utils/logs/empresa_12.log
...
2026-07-09 23:22:36 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 383e2aac; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/soporte_remoto.go
- backend/handlers/super_rustdesk_config.go
...
- documentos/descripcion_de_modulos
- documentos/diagramas/diagramas_sistema_pcs.md
- documentos/diagramas/documentacion_tecnica_completa.md
...
- documentos/mapa_modulos.md
- documentos/matriz_roles_permisos_pos_multiempresa.md
- web/js/super_documentacion_tecnica_data.js
- web/super/configuracion_avanzada.html
- web/super/diagramas/arquitectura_general.html
- web/super/diagramas/casos_de_uso.html
- web/super/diagramas/cierre_de_venta.html
- web/super/diagramas/despliegue_rs.html
- web/super/diagramas/diagrama_de_clases_uml.html
- web/super/diagramas/diagrama_de_componentes.html
- web/super/diagramas/diagrama_de_despliegue.html
- web/super/diagramas/diagrama_de_flujo_de_datos.html
- web/super/diagramas/diagrama_de_paquetes.html
- web/super/diagramas/diagrama_entidad_relacion_postgresql.html
- web/super/diagramas/diagramas_de_estados.html
- web/super/diagramas/diagramas_de_estados_2.html
- web/super/diagramas/diagramas_de_estados_3.html
- web/super/diagramas/documentacion_tecnica_completa.html
- web/super/diagramas/erd_global_resumido_por_dominios.html
- web/super/diagramas/facturacion_electronica_dian.html
- web/super/diagramas/login_y_resolucion_de_empresa.html
- web/super/diagramas/mapa_de_modulos.html
...
2026-07-10 09:47:49 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 004d0ea2; PushStatus: OK
Archivos modificados:
- backend/db/auditoria_super.go
- backend/db/ubicacion_gps.go
- backend/handlers/ubicacion_gps.go
- backend/handlers/ubicacion_gps_validation_test.go
- documentos/descripcion_de_modulos
- documentos/estructura_bd.md
- documentos/historial_de_cambios
- web/super/licencias_resumen.html
...
2026-07-11 01:42:40 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: f1c893ee; PushStatus: OK
Archivos modificados:
- backend/handlers/carritos_compras.go
- documentos/descripcion_de_modulos
- documentos/estructura_bd.md
...
2026-07-13 05:35:18 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: cd31925e; PushStatus: OK
Archivos modificados:
- backend/ai/enterprise.go
- backend/ai/policies.go
- backend/ai/policies_test.go
- backend/db/ai_enterprise.go
- backend/db/nextcloud.go
- backend/handlers/ai_enterprise_orchestrator.go
- backend/handlers/email_corporativo_handlers.go
...
- deploy/README-compose-platform.md
- deploy/docker-compose.platform.yml
- deploy/scripts/vps-delete-mailu-mailbox.sh
- documentos/CHANGELOG.md
- documentos/descripcion_de_archivos
- documentos/descripcion_de_modulos
- documentos/descripcion_del_proyecto
...
2026-07-14 02:50:07 - Mensaje: feat: base movil Flutter y descarga oficial; Commit: 07b52f78; PushStatus: OK
Archivos modificados:
- .github/workflows/mobile-ci.yml
- .github/workflows/mobile-release.yml
- .gitignore
- backend/handlers/mobile_api_v1.go
- backend/handlers/mobile_api_v1_test.go
- documentos/CHANGELOG.md
- documentos/api/mobile_api_v1.md
- documentos/api/openapi.mobile.v1.yaml
- documentos/arquitectura_aplicacion_movil.md
- documentos/comandos_codex.md
- documentos/contexto_especifico_del_sistema.md
- documentos/contratos_api_movil.md
- documentos/desarrollo_paralelo_web_movil.md
- documentos/descripcion_de_archivos
- documentos/descripcion_de_modulos
- documentos/historial_de_cambios
- documentos/mapa_modulos.md
- documentos/publicacion_android_ios.md
- mobile/README.md
- mobile/powerful_control_system_app/README.md
- mobile/powerful_control_system_app/analysis_options.yaml
- mobile/powerful_control_system_app/assets/branding/pcs_app_icon.png
- mobile/powerful_control_system_app/lib/app/app.dart
- mobile/powerful_control_system_app/lib/app/providers.dart
- mobile/powerful_control_system_app/lib/authentication/data/auth_repository.dart
- mobile/powerful_control_system_app/lib/authentication/domain/mobile_account.dart
- mobile/powerful_control_system_app/lib/authentication/presentation/login_screen.dart
- mobile/powerful_control_system_app/lib/authentication/presentation/session_guard.dart
- mobile/powerful_control_system_app/lib/authentication/presentation/startup_screen.dart
- mobile/powerful_control_system_app/lib/config/app_environment.dart
- mobile/powerful_control_system_app/lib/core/connectivity/connectivity_controller.dart
- mobile/powerful_control_system_app/lib/core/errors/api_exception.dart
- mobile/powerful_control_system_app/lib/core/network/api_client.dart
- mobile/powerful_control_system_app/lib/core/storage/secure_session_store.dart
- mobile/powerful_control_system_app/lib/features/companies/data/company_repository.dart
- mobile/powerful_control_system_app/lib/features/companies/domain/company.dart
- mobile/powerful_control_system_app/lib/features/companies/presentation/company_selector_screen.dart
- mobile/powerful_control_system_app/lib/features/dashboard/presentation/dashboard_screen.dart
- mobile/powerful_control_system_app/lib/features/products/data/product_repository.dart
- mobile/powerful_control_system_app/lib/features/products/domain/product.dart
- mobile/powerful_control_system_app/lib/features/products/presentation/products_screen.dart
- mobile/powerful_control_system_app/lib/main.dart
- mobile/powerful_control_system_app/lib/routing/app_router.dart
- mobile/powerful_control_system_app/pubspec.yaml
- mobile/powerful_control_system_app/test/app_environment_test.dart
- mobile/powerful_control_system_app/test/company_test.dart
- scripts/generar_aplicacion_android.ps1
- scripts/generar_aplicacion_ios.ps1
- scripts/rs.ps1
- web/administrar_empresa.html
...
2026-07-14 19:40:45 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: bcc8a6b9; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/db/async_jobs.go
- backend/internal/platform/worker/worker.go
- backend/internal/platform/worker/worker_test.go
- documentos/arquitectura_aplicacion_movil.md
- documentos/auditoria_modular_preproduccion_20260714.md
- documentos/descripcion_de_archivos
- documentos/descripcion_de_modulos
- documentos/historial_de_cambios
- documentos/plan_101_arquitectura_modular.md
- documentos/preparacion_produccion_y_app_movil.md
- mobile/powerful_control_system_app/.gitignore
- mobile/powerful_control_system_app/.metadata
- mobile/powerful_control_system_app/README.md
- mobile/powerful_control_system_app/android/.gitignore
- mobile/powerful_control_system_app/android/app/build.gradle.kts
- mobile/powerful_control_system_app/android/app/src/debug/AndroidManifest.xml
- mobile/powerful_control_system_app/android/app/src/main/AndroidManifest.xml
- mobile/powerful_control_system_app/android/app/src/main/kotlin/com/powerfulcontrolsystem/pcs/MainActivity.kt
- mobile/powerful_control_system_app/android/app/src/main/res/drawable-v21/launch_background.xml
- mobile/powerful_control_system_app/android/app/src/main/res/drawable/launch_background.xml
- mobile/powerful_control_system_app/android/app/src/main/res/mipmap-hdpi/ic_launcher.png
- mobile/powerful_control_system_app/android/app/src/main/res/mipmap-mdpi/ic_launcher.png
- mobile/powerful_control_system_app/android/app/src/main/res/mipmap-xhdpi/ic_launcher.png
- mobile/powerful_control_system_app/android/app/src/main/res/mipmap-xxhdpi/ic_launcher.png
- mobile/powerful_control_system_app/android/app/src/main/res/mipmap-xxxhdpi/ic_launcher.png
- mobile/powerful_control_system_app/android/app/src/main/res/values-night/styles.xml
- mobile/powerful_control_system_app/android/app/src/main/res/values/styles.xml
- mobile/powerful_control_system_app/android/app/src/profile/AndroidManifest.xml
- mobile/powerful_control_system_app/android/build.gradle.kts
- mobile/powerful_control_system_app/android/gradle.properties
- mobile/powerful_control_system_app/android/gradle/wrapper/gradle-wrapper.properties
- mobile/powerful_control_system_app/android/key.properties.example
- mobile/powerful_control_system_app/android/settings.gradle.kts
- mobile/powerful_control_system_app/ios/.gitignore
- mobile/powerful_control_system_app/ios/Flutter/AppFrameworkInfo.plist
- mobile/powerful_control_system_app/ios/Flutter/Debug.xcconfig
- mobile/powerful_control_system_app/ios/Flutter/Release.xcconfig
- mobile/powerful_control_system_app/ios/Runner.xcodeproj/project.pbxproj
- mobile/powerful_control_system_app/ios/Runner.xcodeproj/project.xcworkspace/contents.xcworkspacedata
- mobile/powerful_control_system_app/ios/Runner.xcodeproj/project.xcworkspace/xcshareddata/IDEWorkspaceChecks.plist
- mobile/powerful_control_system_app/ios/Runner.xcodeproj/project.xcworkspace/xcshareddata/WorkspaceSettings.xcsettings
- mobile/powerful_control_system_app/ios/Runner.xcodeproj/xcshareddata/xcschemes/Runner.xcscheme
- mobile/powerful_control_system_app/ios/Runner.xcworkspace/contents.xcworkspacedata
- mobile/powerful_control_system_app/ios/Runner.xcworkspace/xcshareddata/IDEWorkspaceChecks.plist
- mobile/powerful_control_system_app/ios/Runner.xcworkspace/xcshareddata/WorkspaceSettings.xcsettings
- mobile/powerful_control_system_app/ios/Runner/AppDelegate.swift
- mobile/powerful_control_system_app/ios/Runner/Assets.xcassets/AppIcon.appiconset/Contents.json
- mobile/powerful_control_system_app/ios/Runner/Assets.xcassets/AppIcon.appiconset/Icon-App-1024x1024@1x.png
- mobile/powerful_control_system_app/ios/Runner/Assets.xcassets/AppIcon.appiconset/Icon-App-20x20@1x.png
- mobile/powerful_control_system_app/ios/Runner/Assets.xcassets/AppIcon.appiconset/Icon-App-20x20@2x.png
- mobile/powerful_control_system_app/ios/Runner/Assets.xcassets/AppIcon.appiconset/Icon-App-20x20@3x.png
- mobile/powerful_control_system_app/ios/Runner/Assets.xcassets/AppIcon.appiconset/Icon-App-29x29@1x.png
- mobile/powerful_control_system_app/ios/Runner/Assets.xcassets/AppIcon.appiconset/Icon-App-29x29@2x.png
- mobile/powerful_control_system_app/ios/Runner/Assets.xcassets/AppIcon.appiconset/Icon-App-29x29@3x.png
- mobile/powerful_control_system_app/ios/Runner/Assets.xcassets/AppIcon.appiconset/Icon-App-40x40@1x.png
- mobile/powerful_control_system_app/ios/Runner/Assets.xcassets/AppIcon.appiconset/Icon-App-40x40@2x.png
- mobile/powerful_control_system_app/ios/Runner/Assets.xcassets/AppIcon.appiconset/Icon-App-40x40@3x.png
- mobile/powerful_control_system_app/ios/Runner/Assets.xcassets/AppIcon.appiconset/Icon-App-50x50@1x.png
- mobile/powerful_control_system_app/ios/Runner/Assets.xcassets/AppIcon.appiconset/Icon-App-50x50@2x.png
- mobile/powerful_control_system_app/ios/Runner/Assets.xcassets/AppIcon.appiconset/Icon-App-57x57@1x.png
- mobile/powerful_control_system_app/ios/Runner/Assets.xcassets/AppIcon.appiconset/Icon-App-57x57@2x.png
- mobile/powerful_control_system_app/ios/Runner/Assets.xcassets/AppIcon.appiconset/Icon-App-60x60@2x.png
- mobile/powerful_control_system_app/ios/Runner/Assets.xcassets/AppIcon.appiconset/Icon-App-60x60@3x.png
- mobile/powerful_control_system_app/ios/Runner/Assets.xcassets/AppIcon.appiconset/Icon-App-72x72@1x.png
- mobile/powerful_control_system_app/ios/Runner/Assets.xcassets/AppIcon.appiconset/Icon-App-72x72@2x.png
- mobile/powerful_control_system_app/ios/Runner/Assets.xcassets/AppIcon.appiconset/Icon-App-76x76@1x.png
- mobile/powerful_control_system_app/ios/Runner/Assets.xcassets/AppIcon.appiconset/Icon-App-76x76@2x.png
- mobile/powerful_control_system_app/ios/Runner/Assets.xcassets/AppIcon.appiconset/Icon-App-83.5x83.5@2x.png
- mobile/powerful_control_system_app/ios/Runner/Assets.xcassets/LaunchImage.imageset/Contents.json
- mobile/powerful_control_system_app/ios/Runner/Assets.xcassets/LaunchImage.imageset/LaunchImage.png
- mobile/powerful_control_system_app/ios/Runner/Assets.xcassets/LaunchImage.imageset/LaunchImage@2x.png
- mobile/powerful_control_system_app/ios/Runner/Assets.xcassets/LaunchImage.imageset/LaunchImage@3x.png
- mobile/powerful_control_system_app/ios/Runner/Assets.xcassets/LaunchImage.imageset/README.md
- mobile/powerful_control_system_app/ios/Runner/Base.lproj/LaunchScreen.storyboard
- mobile/powerful_control_system_app/ios/Runner/Base.lproj/Main.storyboard
- mobile/powerful_control_system_app/ios/Runner/Info.plist
- mobile/powerful_control_system_app/ios/Runner/Runner-Bridging-Header.h
- mobile/powerful_control_system_app/ios/Runner/SceneDelegate.swift
- mobile/powerful_control_system_app/ios/RunnerTests/RunnerTests.swift
- mobile/powerful_control_system_app/lib/app/app.dart
- mobile/powerful_control_system_app/lib/app/providers.dart
- mobile/powerful_control_system_app/lib/authentication/data/auth_repository.dart
- mobile/powerful_control_system_app/lib/authentication/domain/mobile_account.dart
...
- mobile/powerful_control_system_app/lib/features/products/presentation/products_screen.dart
- mobile/powerful_control_system_app/lib/routing/app_router.dart
- mobile/powerful_control_system_app/pubspec.lock
- mobile/powerful_control_system_app/test/company_test.dart

2026-07-15 03:06:53 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 0d15dcd1; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/cmd/pcs-worker/main.go
- backend/db/async_jobs.go
- backend/db/async_jobs_test.go
- backend/db/documentos_transaccionales.go
- backend/db/migrations.go
- backend/db/migrations_test.go
- backend/db/modulos_faltantes.go
- backend/db/portal_visitas.go
- backend/handlers/modulos_faltantes.go
- backend/handlers/payments_handlers.go
- backend/handlers/portal_visitas.go
- backend/handlers/runtime_health.go
- backend/handlers/runtime_health_test.go
- backend/internal/platform/modules/catalog.go
- backend/internal/platform/modules/catalog_test.go
- backend/internal/platform/runtimeconfig/config.go
- backend/internal/platform/runtimeconfig/config_test.go
- backend/internal/platform/worker/worker.go
- backend/main.go
- backend/utils/auth_middleware_test.go
- backend/utils/utils.go
...
- documentos/api/openapi.generated.yaml
- documentos/arquitectura_aplicacion_movil.md
- documentos/arquitectura_escalable_y_modular.md
- documentos/comandos_codex.md
- documentos/contexto_general_del_sistema.md
- documentos/descripcion_de_archivos
- documentos/descripcion_de_modulos
- documentos/historial_de_cambios
- documentos/mapa_modulos.md
- documentos/plan_preproduccion.md
- documentos/preparacion_final_produccion.md
- documentos/preparacion_produccion_y_app_movil.md

2026-07-15 04:36:00 - Mensaje: rs: actualizar repositorio y sincronizar VPS; Commit: 6c6548dd; PushStatus: OK
Archivos modificados:
- CHANGELOG.md
- backend/cmd/pcs-migrate/main.go
- backend/cmd/pcs-worker/main.go
- backend/cmd/pcs-worker/periodic.go
- backend/db/admin_principal_delegaciones.go
...
- backend/db/logistica_wms.go
- backend/db/migrations.go
- backend/db/mobile_api_idempotency.go
- backend/db/modulos_empresariales_colombia.go
- backend/db/modulos_faltantes.go
- backend/db/modulos_plantillas_nuevas.go
- backend/db/nextcloud.go
...
- backend/db/soportes_compras_ia.go
- backend/db/sql_compat.go
- backend/db/sql_schema_guard_test.go
- backend/db/super_alertas.go
- backend/db/super_correos_masivos.go
- backend/db/super_errores_sistema.go
- backend/db/super_mantenimiento_agentes.go
...
- backend/internal/platform/runtimeconfig/config.go
- backend/internal/platform/runtimeconfig/config_test.go
- backend/internal/platform/worker/outbox.go
- backend/internal/platform/worker/worker.go
- backend/internal/platform/worker/worker_test.go
- backend/main.go
- deploy/docker-compose.platform.yml
- documentos/README.md
- documentos/arquitectura_modulos_universales.md
- documentos/arquitectura_movil_v1.md
- documentos/arquitectura_workers_outbox.md
- documentos/contexto_general_del_sistema.md
- documentos/descripcion_de_archivos
- documentos/descripcion_de_modulos
- documentos/despliegue_inmutable.md
- documentos/estado_modulos_produccion.md
- documentos/historial_de_cambios
- documentos/mapa_modulos.md
- documentos/matriz_integracion_plantillas.md
- documentos/plan_preproduccion.md
