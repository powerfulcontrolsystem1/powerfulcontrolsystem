...
- Cambios previos: commits y PR. Decisiones vigentes: `decisiones_tecnicas.md`
  y ADR del módulo.
...
Todo archivo nuevo se enlaza desde la fuente o mapa que lo consume. Un cambio
funcional actualiza `descripcion_de_modulos` y, cuando aplica, matriz de roles,
estructura de datos, contratos y diagramas. Para una tarea transversal, la PR
incluye evidencia minimizada de backend, frontend y operación.
