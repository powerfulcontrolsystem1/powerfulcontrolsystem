> Archivo histórico del documento anterior a la reorganización del 2026-09-05.
> Origen: `RESUMEN_DEL_PROYECTO.md`. Sus instrucciones y estados no son vigentes.
> Consulte el documento de origen para trabajar; se conserva la información previa.
