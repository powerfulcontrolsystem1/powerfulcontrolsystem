...
> Origen: `documentos/README.md`. Sus instrucciones y estados no son vigentes.
...
- 2026-05-06 / actualizado 2026-05-14: ampliado `CRM comercial` con capa `CRM y ventas avanzadas`: metas comerciales, dashboard de pipeline/forecast, scoring de leads, agenda y conversion a cotizacion, API `/api/empresa/crm_avanzado`, pantalla canonica `web/administrar_empresa/crm_comercial.html` y documento `documentos/crm_ventas_avanzadas.md`.
